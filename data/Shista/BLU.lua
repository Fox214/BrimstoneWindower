...
function init_gear_sets()
	...
	sets.idle = {ammo="Amar Cluster",
		...
		body="Hashishin Mintan +3",hands="Hashi. Bazu. +2",ring1="Defending Ring",ring2="Renaye Ring +1",
		back="Solemnity Cape",waist="Plat. Mog. Belt",legs="Carmine Cuisses +1",feet="Nyame Sollerets"}
	...
	sets.Mode.Acc = set_combine(sets.engaged, {ammo="Mantoptera Eye",
		head="Hashishin Kavuk +2",neck="Combatant's Torque",lear="Zennaroi Earring",rear="Hashi. Earring +1",
	...
	sets.engaged.DW.Club = set_combine(sets.engaged, {main="Maxentius",sub="Sakpata's Sword"})
	sets.engaged.Shield.Club = set_combine(sets.engaged, {main="Maxentius",sub="Genmei Shield"})
	...
	sets.midcast['Blue Magic'].PhysicalInt = set_combine(sets.midcast['Blue Magic'].Physical,
		...
		back="Toro Cape",waist="Wanion Belt",legs="Jhakri Slops +2",feet="Jhakri Pigaches +2"})
	...
	sets.defense.PDT = {
		...
		body="Hashishin Mintan +3",hands="Hashi. Bazu. +2",ring1="Defending Ring",ring2="Patricius Ring",
	...
	sets.defense.MDT = {
		...
		body="Hashishin Mintan +3",hands="Hashi. Bazu. +2",ring1="Defending Ring",ring2="Moonbeam Ring",
		back="Reiki Cloak",waist="Plat. Mog. Belt",legs="Hashishin Tayt +2",feet="Nyame Sollerets"}
