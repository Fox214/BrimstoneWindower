...
function init_gear_sets()
	...
	sets.idle = {head="Valorous Mask",neck="Elite Royal Collar",lear="Infused Earring",rear="Etiolation Earring",
        body="Sacro Breastplate",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="Vengeful Ring",
        back=gear.stpCape,waist="Plat. Mog. Belt",legs="Kasuga Haidate +2",feet="Danzo Sune-Ate"}
    ...
    sets.engaged = {
        ...
        body="Kasuga Domaru +2",hands="Tatena. Gote +1",ring1="Niqmaddu Ring",ring2="Ilabrat Ring",
	...
	sets.Mode.Acc = set_combine(sets.engaged, {
		head="Flam. Zucchetto +2",neck="Sam. Nodowa +1",lear="Zennaroi Earring",rear="Digni. Earring",
		body="Kasuga Domaru +2",hands="Kasuga Kote +3",ring1="Cacoethic Ring +1",ring2="Regal Ring",
		back=gear.stpCape,waist="Olseni Belt",legs="Kasuga Haidate +2",feet="Wakido Sune. +3"})
	...
	sets.Mode.sTP = set_combine(sets.engaged, {
		head="Flam. Zucchetto +2",neck="Sam. Nodowa +1",lear="Tripudio Earring",rear="Kasuga Earring +1",
		body="Kasuga Domaru +2",hands="Otronif Gloves +1",ring1="Rajas Ring",ring2="Ilabrat Ring",
	...
	-- other Sets    
	sets.macc = {
		head="Nyame Helm",lear="Gwati Earring",
		body="Kasuga Domaru +2",hands="Kasuga Kote +3",ring1="Sangoma Ring",ring2="Metamor. Ring +1",
		legs="Nyame Flanchard",feet="Nyame Sollerets"}
	sets.PDL = {neck="Sam. Nodowa +1"}
	sets.empy = {head="Kasuga Kabuto +1",
		body="Kasuga Domaru +2",hands="Kasuga Kote +3",
		legs="Kasuga Haidate +2",feet="Kas. Sune-Ate +2"}

	-- Sets with weapons defined.
	sets.engaged.Polearm = {}
	sets.engaged.GreatKatana = {}
	sets.engaged.GreatKatana = set_combine(sets.engaged, {main="Hosodachi",sub="Utu Grip"})
	...
	-- Racc, Ratt, AGI
    sets.midcast.RA = {
        head="Nyame Helm",neck="Combatant's Torque",lear="Infused Earring",rear="Enervating Earring",
        body="Nyame Mail",hands="Kasuga Kote +3",ring1="Paqichikaji Ring",ring2="Cacoethic Ring +1",
        waist="Eschan Stone",legs="Nyame Flanchard",feet="Wakido Sune. +3"}
	...
	sets.defense.PDT = {
        ...
        body="Kasuga Domaru +2",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="Patricius Ring",
    ...
    sets.defense.MDT = {
        ...
        body="Kasuga Domaru +2",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="Vengeful Ring",
