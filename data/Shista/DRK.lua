...
function init_gear_sets()
	...
	sets.idle = {head="Valorous Mask",neck="Elite Royal Collar",lear="Moonshade Earring",rear="Ethereal Earring",
		body="Sacro Breastplate",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="Patricius Ring",
	...
	-- other Sets    
	sets.macc = {
		head="Nyame Helm",lear="Malignance Earring",rear="Gwati Earring",
