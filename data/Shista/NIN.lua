...
function init_gear_sets()
    ...
    sets.engaged = {
        ...
        body="Tatena. Harama. +1",hands="Tatena. Gote +1",ring1="Epona's Ring",ring2="Hetairoi Ring",
        back=gear.critCape,waist="Sailfi Belt +1",legs="Mpaca's Hose",feet="Hattori Kyahan +3"}
 
	-- Basic Mode definitions
	sets.Mode = {}
	sets.Mode.Acc = set_combine(sets.engaged, {
        head="Hattori Zukin +2",neck="Ninja Nodowa +2",lear="Zennaroi Earring",rear="Hattori Earring +1",
        body="Hachiya Chain. +3",hands="Tatena. Gote +1",ring1="Cacoethic Ring +1",ring2="Regal Ring",
        back=gear.critCape,waist="Olseni Belt",legs="Hattori Hakama +2",feet="Hattori Kyahan +3"})
	...
	sets.Mode.DA = set_combine(sets.engaged, {
        ...
        back="Atheling Mantle",waist="Sarissapho. Belt",legs="Mpaca's Hose",feet="Loyalist Sabatons"})
	sets.Mode.SB = set_combine(sets.engaged, {hands="Hachiya Tekko +2"})
	-- sTP then subtle blow
	sets.Mode.sTP = set_combine(sets.engaged, {
        head="Malignance Chapeau",neck="Iskur Gorget",lear="Tripudio Earring",rear="Enervating Earring",
        body="Tatena. Harama. +1",hands="Tatena. Gote +1",ring1="Rajas Ring",ring2="K'ayres Ring",
	...
	sets.macc = {
        ...
        back="Yokaze Mantle",waist="Eschan Stone",legs="Hattori Hakama +2",feet="Hattori Kyahan +3"}
	sets.PDL = {head="Malignance Chapeau",neck="Ninja Nodowa +2",rear="Hattori Earring +1"}
	sets.empy = {head="Hattori Zukin +2",
		body="Hattori Ningi +3",hands="Hattori Tekko",
		legs="Hattori Hakama +2",feet="Hattori Kyahan +3"}		
    ...
    sets.precast.JA['Sange'] = {legs="Mochi. Chainmail +2"}
    ...
    sets.precast.FC = {head=gear.hercAcc,neck="Orunmila's Torque",lear="Etiolation Earring",
        ...
        legs="Gyve Trousers"}
    sets.precast.FC.Utsusemi = set_combine(sets.precast.FC, {neck="Magoraga Beads",body="Mochi. Chainmail +2",back="Andartia's Mantle",feet="Hattori Kyahan +3"})
    ...
    sets.midcast.ElementalNinjutsu = set_combine(sets.midcast.NinjutsuDebuff, {
        ...
        body="Nyame Mail",hands="Hattori Tekko",ring1="Sangoma Ring",ring2="Metamor. Ring +1",
	...
	-- Racc, Ratt, AGI
    sets.midcast.RA = {
        head="Hattori Zukin +2",neck="Ninja Nodowa +2",rear="Enervating Earring",
        body="Nyame Mail",hands="Hachiya Tekko +2",ring1="Paqichikaji Ring",ring2="Cacoethic Ring +1",
        back="Yokaze Mantle",waist="Eschan Stone",legs="Nyame Flanchard",feet="Hattori Kyahan +3"}
    ...
    sets.defense.Evasion = {
        ...
        back="Yokaze Mantle",waist="Koga Sarashi",legs="Nyame Flanchard",feet="Hattori Kyahan +3"}

    sets.defense.PDT = { 
        head="Hattori Zukin +2",neck="Elite Royal Collar",
        body="Hattori Ningi +3",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="Patricius Ring",
        back=gear.critCape,waist="Plat. Mog. Belt",legs="Nyame Flanchard",feet="Nyame Sollerets"}

    sets.defense.MDT = { 
        head="Hattori Zukin +2",neck="Elite Royal Collar",lear="Etiolation Earring",rear="Eabani Earring",
        body="Hattori Ningi +3",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="Vengeful Ring",
        back=gear.critCape,waist="Plat. Mog. Belt",legs="Nyame Flanchard",feet="Nyame Sollerets"}
    ...
    sets.buff.Yonin = {head="Mochi. Hatsuburi +3",legs="Hattori Hakama +2"}
