...
function init_gear_sets()
	...
	sets.idle = {
		...
		back="Solemnity Cape",waist="Plat. Mog. Belt",legs="Carmine Cuisses +1",feet="Orion Socks +2"}
	...
	sets.engaged = {
        ...
        body="Meg. Cuirie +2",hands="Tatena. Gote +1",ring1="Epona's Ring",ring2="Hetairoi Ring",
	...
	sets.Mode.Acc = set_combine(sets.engaged, {
		...
		body="Meg. Cuirie +2",hands="Tatena. Gote +1",ring1="Cacoethic Ring +1",ring2="Regal Ring",
	...
	sets.Mode.sTP = set_combine(sets.engaged, {
		head="Malignance Chapeau",neck="Iskur Gorget",lear="Sherida Earring",rear="Enervating Earring",
	...
	sets.macc = {
		...
		body="Nyame Mail",hands="Nyame Gauntlets",ring1="Sangoma Ring",ring2="Mummu Ring",
		legs="Nyame Flanchard",feet="Amini Bottillons +2"}
	sets.PDL = {head="Malignance Chapeau",rear="Amini Earring +1",
		body="Amini Caban"}
	sets.empy = {head="Amini Gapette",
		body="Amini Caban",hands="Amini Glove. +1",
	...
	sets.precast.RA = {
		head="Orion Beret +2",
		body="Amini Caban",hands="Iuitl Wristbands",
	...
	sets.midcast.RA = {
		head="Meghanada Visor +2",neck="Iskur Gorget",lear="Enervating Earring",rear="Infused Earring",
	...
	sets.midcast.RA.Acc = set_combine(sets.midcast.RA,
		...
		body="Meg. Cuirie +2",hands="Meg. Gloves +2",ring1="Paqichikaji Ring",ring2="Cacoethic Ring +1",
		back="Belenus's Cape",waist="Eschan Stone",legs="Meg. Chausses +2"})
