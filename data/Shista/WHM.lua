...
function init_gear_sets()
	...
	sets.Mode.DA = set_combine(sets.engaged, {
        ...
        body="Ayanmo Corazza +2",hands="Bunzi's Gloves",ring1="Hetairoi Ring",
	...
	sets.engaged.Club = {}
	sets.engaged.Staff = {}
	sets.engaged.Club = set_combine(sets.engaged, {main="Bunzi's Rod",sub="Genmei Shield"})
    ...
    sets.precast.WS['Flash Nova'] = set_combine(sets.precast.WS, {
        head="Nyame Helm",lear="Malignance Earring",rear="Friomisi Earring",
	...
	sets.midcast.CureMelee = set_combine(sets.midcast.Healing, {ammo="Incantor Stone",
        ...
        body="Bunzi's Robe",hands="Telchine Gloves",ring1="Naji's Loop",ring2="Lebeche Ring",
        back="Solemnity Cape",legs="Sifahir Slacks",feet="Piety Duckbills +1"})

	sets.midcast.Cure = set_combine(sets.midcast.CureMelee, {main="Bunzi's Rod",sub="Genmei Shield"})

    sets.midcast.CureSolace =  set_combine(sets.midcast.CureMelee, {main="Bunzi's Rod",sub="Genmei Shield",
        body="Ebers Bliaut",back="Alaunus's Cape"})

    sets.midcast.Curaga = set_combine(sets.midcast.CureMelee, {main="Bunzi's Rod",sub="Genmei Shield"})
    ...
    sets.midcast['Enhancing Magic'] = { main="Exemplar",sub="Enki Strap",
        ...
        body="Telchine Chas.",hands="Dynasty Mitts",
