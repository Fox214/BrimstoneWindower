...
function init_gear_sets()
	...
	sets.engaged.DW.Dagger = set_combine(sets.engaged, {main="Kukri",sub="Poison Knife"})
    ...
    sets.defense.PDT = {
        ...
        body="Meg. Cuirie +2",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="Patricius Ring",
