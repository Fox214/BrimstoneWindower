...
function init_gear_sets()
	...
	sets.idle = {head="Valorous Mask",neck="Elite Royal Collar",lear="Moonshade Earring",rear="Ethereal Earring",
		body="Nyame Mail",hands="Pel. Vambraces +3",ring1="Defending Ring",ring2="Renaye Ring +1",
		back=gear.critCape,waist="Plat. Mog. Belt",legs="Carmine Cuisses +1",feet="Nyame Sollerets"}
	...
	sets.Mode.Acc = set_combine(sets.engaged, { ammo="Amar Cluster",
        head="Peltast's Mezail +3",neck="Dgn. Collar +2",lear="Zennaroi Earring",rear="Pel. Earring +1",
	...
	sets.Mode.DA = set_combine(sets.engaged, { ammo="Coiste Bodhar",
        ...
        body="Emicho Haubert",hands="Pel. Vambraces +3",ring1="Hetairoi Ring",ring2="Niqmaddu Ring",
	...
	-- other Sets    
	sets.macc = {
		head="Peltast's Mezail +3",lear="Gwati Earring",
	...
	sets.defense.PDT = {
		...
		body="Nyame Mail",hands="Pel. Vambraces +3",ring1="Defending Ring",ring2="Patricius Ring",
	...
	sets.defense.MDT = {
		...
		body="Nyame Mail",hands="Pel. Vambraces +3",ring1="Defending Ring",ring2="Moonbeam Ring",
