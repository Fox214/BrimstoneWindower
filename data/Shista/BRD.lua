...
function init_gear_sets()
	...
	sets.Mode.sTP = set_combine(sets.engaged, {
		...
		ring1="Ilabrat Ring",ring2="Rajas Ring",
	...
	sets.engaged.Staff = set_combine(sets.engaged, {main="Ungeri Staff", sub="Enki Strap"})
	...
	sets.precast.FC = {
		head="Marduk's Tiara",neck="Orunmila's Torque",lear="Etiolation Earring",
		body="Marduk's Jubbah",hands="Marduk's Dastanas",ring1="Kishar Ring",ring2="Prolix Ring",
	...
	sets.Singing = set_combine(sets.Macc, { 
		head="Marduk's Tiara",neck="Incanter's Torque",lear="Singing Earring",rear="Fili Earring +2",
		body="Brioso Just.",hands="Brioso Cuffs +1",ring2="Renaye Ring +1",
		back="Astute Cape",legs="Fili Rhingrave"})
	sets.String = set_combine(sets.Singing, {
		head="Brioso Roundlet",neck="Incanter's Torque",rear="Musical Earring",
	...
	sets.midcast.DaurdablaDummy = set_combine(sets.idle, {main="Marin Staff +1",sub="Benthos Grip",range=info.ExtraSongInstrument})
