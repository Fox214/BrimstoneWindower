...
function init_gear_sets()
    ...
    sets.engaged = { ammo="Homiliary",
        head="Arbatel Bonnet +3",neck="Combatant's Torque",lear="Bladeborn Earring",rear="Steelflash Earring",
        body="Arbatel Gown +3",hands="Arbatel Bracers +3",ring1="Patricius Ring",ring2="Apate Ring",
        waist="Eschan Stone",legs="Arbatel Pants +3",feet="Arbatel Loafers +3"}

	-- Basic Mode definitions
	sets.Mode = {}
	sets.Mode.Acc = set_combine(sets.engaged, {ammo="Amar Cluster",
		head="Arbatel Bonnet +3",neck="Combatant's Torque",lear="Zennaroi Earring",rear="Digni. Earring",
		body="Arbatel Gown +3",hands="Arbatel Bracers +3",ring1="Mars's Ring",ring2="Cacoethic Ring +1",
		waist="Olseni Belt",legs="Arbatel Pants +3",feet="Arbatel Loafers +3"})
	...
	sets.macc = {main="Musa",sub="Khonsu",ammo="Pemphredo Tathlum",
        head="Arbatel Bonnet +3",neck="Argute Stole +2",lear="Malignance Earring",rear="Arbatel Earring +1",
        body="Arbatel Gown +3",hands="Arbatel Bracers +3",ring1="Sangoma Ring",ring2="Metamor. Ring +1",
        back="Lugh's Cape",waist="Luminary Sash",legs="Arbatel Pants +3",feet="Arbatel Loafers +3"}
	sets.PDL = {}
    ...
    sets.precast.JA['Enlightenment'] = {legs="Pedagogy Gown"}
    sets.precast.JA['Tranquility'] = {legs="Pedagogy Bracers"}
    sets.precast.JA['Equanimity'] = {legs="Pedagogy Bracers"}
    ...
    sets.precast.FC = {main="Musa",sub="Khonsu",ammo="Incantor Stone",
        ...
        body="Shango Robe",hands="Acad. Bracers +2",ring1="Kishar Ring",ring2="Prolix Ring",
        back="Perimede Cape",waist="Embla Sash",legs="Psycloth Lappas",feet="Acad. Loafers +1"}
    ...
    sets.midcast.StatusRemoval = {
		...
		body="Pedagogy Gown",hands="Ayao's Gages",ring1="Ephedra Ring",legs="Acad. Pants +2",feet="Peda. Loafers +1"}
    ...
    sets.midcast['Elemental Magic'] = {main="Bunzi's Rod",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
        head="Arbatel Bonnet +3",neck="Argute Stole +2",lear="Malignance Earring",rear="Arbatel Earring +1",
        body="Arbatel Gown +3",hands="Arbatel Bracers +3",ring1="Strendu Ring",ring2="Metamor. Ring +1",
    ...
    sets.midcast['Elemental Magic'].INT = set_combine(sets.midcast['Elemental Magic'], {main="Marin Staff +1",sub="Enki Strap",ammo="Ghastly Tathlum +1",
        head="Acad. Mortar. +3",neck="Argute Stole +2",lear="Malignance Earring",rear="Psystorm Earring",
        body="Arbatel Gown +3",hands="Arbatel Bracers +3",ring1="Mallquis Ring",ring2="Metamor. Ring +1",
	...
	sets.midcast['Elemental Magic'].MAB = set_combine(sets.midcast['Elemental Magic'], {main="Bunzi's Rod",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
        ...
        body="Arbatel Gown +3",hands="Arbatel Bracers +3",ring1="Strendu Ring",
        back="Lugh's Cape",waist="Eschan Stone",legs="Arbatel Pants +3",feet="Merlinic Crackows"})
    ...
    sets.midcast['Elemental Magic'].MB = set_combine(sets.midcast['Elemental Magic'], {main="Bunzi's Rod",sub="Ammurapi Shield",
        ...
        hands="Arbatel Bracers +3",ring1="Mujin Band",
    ...
    sets.midcast.MndEnfeebles = set_combine(sets.midcast['Elemental Magic'].Macc, {main="Marin Staff +1",sub="Mephitis Grip", ammo="Savant's Treatise",
        ...
        body="Acad. Gown +3",hands="Ayao's Gages",ring1="Kishar Ring",ring2="Globidonta Ring",
    ...
    sets.midcast['Dark Magic'] = set_combine(sets.midcast['Elemental Magic'].Macc, {
        ...
        back="Bookworm's Cape",legs="Peda. Pants +2"})
    ...
    sets.midcast.Drain = set_combine(sets.midcast['Dark Magic'],{head="Merlinic Hood",neck="Erra Pendant",ring2="Excelsis Ring",waist="Fucho-no-obi",legs="Peda. Pants +2",feet="Merlinic Crackows"})

    sets.midcast.Aspir = set_combine(sets.midcast.Drain, {})

    sets.midcast.Stun = {ammo="Incantor Stone",
        neck="Sanctity Necklace",lear="Psystorm Earring",rear="Lifestorm Earring",
        back="Kumbira Cape",legs="Peda. Pants +2",feet="Acad. Loafers +1"}
    ...
    -- Defense sets
    sets.defense.PDT = {
        head="Arbatel Bonnet +3",neck="Elite Royal Collar",
        body="Arbatel Gown +3",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="Patricius Ring",
    ...
    sets.defense.MDT = {
        ...
        body="Arbatel Gown +3",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="Vengeful Ring",
        back="Lugh's Cape",waist="Plat. Mog. Belt",legs="Arbatel Pants +3",feet="Nyame Sollerets"}
