...
function init_gear_sets()
	...
	sets.idle = {ammo="Demonry Core",
        head="Nyame Helm",neck="Elite Royal Collar",lear="Infused Earring",rear="Moonshade Earring",
        body="Sacro Breastplate",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="Renaye Ring +1",
        back="Solemnity Cape",waist="Plat. Mog. Belt",legs="Nyame Flanchard",feet="Skd. Jambeaux +1"}
    ...
    sets.idle.Pet.Offensive = set_combine(sets.idle.Pet, {ammo="Demonry Core",
        head="Nyame Helm",neck="Shulmanu Collar",lear="Enmerkar Earring",rear="Domes. Earring",
        body="Nyame Mail",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="Tali'ah Ring",
	...
	sets.engaged = {ammo="Demonry Core",
		head="Valorous Mask",neck="Shulmanu Collar",lear="Sherida Earring",rear="Nukumi Earring +1",
	...
	sets.Mode.Acc = set_combine(sets.engaged, {
		head="Tali'ah Turban +2",neck="Shulmanu Collar",lear="Zennaroi Earring",rear="Nukumi Earring +1",
