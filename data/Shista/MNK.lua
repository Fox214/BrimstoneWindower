...
function init_gear_sets()
    ...
    sets.idle = {ammo="Amar Cluster",
        head="Nyame Helm",neck="Elite Royal Collar",lear="Infused Earring",rear="Etiolation Earring",
        body="Hiza. Haramaki +2",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="Vengeful Ring",
        back="Solemnity Cape",waist="Plat. Mog. Belt",legs="Nyame Flanchard",feet="Herald's Gaiters"}
    ...
    sets.engaged = {ammo="Mantoptera Eye",
        ...
        back="Segomo's Mantle",waist="Black Belt",legs="Mpaca's Hose",feet="Herculean Boots"}
	...
	sets.Mode.DA = set_combine(sets.engaged, {
		...
		back="Atheling Mantle",waist="Sinew Belt",legs="Mpaca's Hose",feet="Herculean Boots"})
	sets.Mode.SB = set_combine(sets.engaged, {head="Bhikku Crown",legs="Mpaca's Hose"})
	sets.Mode.sTP = set_combine(sets.engaged, { ammo="Ginsen",
		...
		body="Tatena. Harama. +1",hands="Otronif Gloves +1",ring1="Rajas Ring",ring2="Ilabrat Ring",
    ...
    -- Defense sets
    sets.defense.HP = {
        head="Nyame Helm",neck="Sanctity Necklace",lear="Etiolation Earring",rear="Eabani Earring",
        body="Nyame Mail",hands="Hesychast's Gloves +1",ring1="K'ayres Ring",ring2="Overbearing Ring",
        back="Anchoret's Mantle",waist="Eschan Stone",legs="Nyame Flanchard",feet="Nyame Sollerets"}
