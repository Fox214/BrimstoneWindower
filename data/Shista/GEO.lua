...
function init_gear_sets()
   ...
   -- .Pet sets are for when Luopan is present.
	...
	sets.macc = {main="Marin Staff +1",sub="Enki Strap",range="Dunna",
        head="Azimuth Hood +2",neck="Bagua Charm +1",lear="Malignance Earring",rear="Azimuth Earring +1",
    ...
    sets.midcast['Elemental Magic'] = { main="Marin Staff +1",sub="Niobid Strap",ammo="Pemphredo Tathlum",
        head="Azimuth Hood +2",neck="Sanctity Necklace",lear="Malignance Earring",rear="Azimuth Earring +1",
    ...
    sets.midcast['Elemental Magic'].INT = set_combine(sets.midcast['Elemental Magic'], 
	   {main="Marin Staff +1",sub="Enki Strap",ammo="Pemphredo Tathlum",
        head="Merlinic Hood",neck="Sibyl Scarf",lear="Malignance Earring",rear="Psystorm Earring",
        body="Jhakri Robe +2",hands="Mallquis Cuffs +2",ring1="Mallquis Ring",ring2="Metamor. Ring +1",
        back=gear.nukeCape,waist="Wanion Belt",legs="Mallquis Trews +2",feet="Mallquis Clogs +2"})
    ...
    sets.midcast['Elemental Magic'].MAB = set_combine(sets.midcast['Elemental Magic'], 
	   {main="Marin Staff +1",sub="Niobid Strap",ammo="Pemphredo Tathlum",
        head="Azimuth Hood +2",neck="Baetyl Pendant",lear="Malignance Earring",rear="Friomisi Earring",
    ...
    sets.midcast['Elemental Magic'].MB = set_combine(sets.midcast['Elemental Magic'], {
		...
		body="Azimuth Coat +2",hands="Amalric Gages",ring1="Mujin Band",
	...
	sets.midcast.Geomancy.entrust = set_combine(sets.midcast.Geomancy,{main="Solstice"})
    ...
    sets.defense.PDT = {
        head="Azimuth Hood +2",
        body="Nyame Mail",hands="Azimuth Gloves +2",ring1="Defending Ring",ring2="Patricius Ring",
        back="Solemnity Cape",waist="Plat. Mog. Belt",legs="Nyame Flanchard",feet="Azimuth Gaiters +2"}

    sets.defense.MDT = {
		head="Azimuth Hood +2",lear="Etiolation Earring",rear="Eabani Earring",
        body="Nyame Mail",hands="Azimuth Gloves +2",ring1="Defending Ring",ring2="Vengeful Ring",
        back="Solemnity Cape",waist="Plat. Mog. Belt",legs="Nyame Flanchard",feet="Azimuth Gaiters +2"}
