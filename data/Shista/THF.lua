...
function init_gear_sets()   
	...
	sets.empy = {head="Skulker's Bonnet",
		...
		legs="Skulker's Culottes",feet="Raider's Poulaines"}
    ...
    sets.TreasureHunter = {head=gear.hercTH, hands="Plun. Armlets", waist="Chaac Belt", feet="Raider's Poulaines"}
    ...
    sets.precast.JA['Despoil'] = {legs="Skulker's Culottes",feet="Raider's Poulaines"}
