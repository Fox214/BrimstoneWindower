...
function init_gear_sets()
	...
	sets.idle = { ammo="Homiliary",
		...
		back="Evasionist's Cape",waist="Plat. Mog. Belt",legs="Carmine Cuisses +1",feet="Nyame Sollerets"}
	...
	sets.engaged = {ammo="Yamarang",
        head="Nyame Helm",neck="Combatant's Torque",lear="Sherida Earring",rear="Erilaz Earring +1",
        body="Nyame Mail",hands="Nyame Gauntlets",ring1="Niqmaddu Ring",ring2="Moonbeam Ring",
        back="Atheling Mantle",waist="Ioskeha Belt",legs="Nyame Flanchard",feet="Nyame Sollerets"}
	...
	sets.Mode.sTP = set_combine(sets.engaged, { ammo="Yamarang",
        ...
        body="Herculean Vest",hands="Umuthi Gloves",ring1="Ilabrat Ring",ring2="Rajas Ring",
	...
	sets.defense.Evasion = { ammo="Amar Cluster",
		...
		back="Evasionist's Cape",legs="Nyame Flanchard",feet="Nyame Sollerets"}

	sets.defense.PDT = {
		head="Nyame Helm",neck="Elite Royal Collar",rear="Erilaz Earring +1",
