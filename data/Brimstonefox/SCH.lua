...
function user_setup()
    ...
    state.CastingMode:options('Normal', 'INT', 'MAB', 'MB', 'Macc', 'Mcrit', 'MDmg', 'Proc', 'TH')
...
function init_gear_sets()
    ...
    sets.idle = { main="Akademos",sub="Khonsu",ammo="Homiliary",
        ...
        body="Arbatel Gown +3",hands="Telchine Gloves",ring1="Murky Ring",ring2="Renaye Ring +1",
        back="Lugh's Cape",waist="Null Belt",legs="Assid. Pants +1",feet="Herald's Gaiters"}
    ...
    sets.engaged = { ammo="Homiliary",
        head="Arbatel Bonnet +3",neck="Null Loop",lear="Crep. Earring",rear="Brutal Earring",
        body="Arbatel Gown +3",hands="Arbatel Bracers +3",ring1="Patricius Ring",ring2="Apate Ring",
	...
	sets.Mode.Acc = set_combine(sets.engaged, {ammo="Amar Cluster",
		head="Arbatel Bonnet +3",neck="Null Loop",lear="Zennaroi Earring",rear="Digni. Earring",
		body="Arbatel Gown +3",hands="Arbatel Bracers +3",ring1="Mars's Ring",ring2="Cacoethic Ring +1",
		back="Null Shawl",waist="Null Belt",legs="Arbatel Pants +3",feet="Arbatel Loafers +3"})
	...
	sets.Mode.sTP = set_combine(sets.engaged, {neck="Combatant's Torque",lear="Crep. Earring",rear="Digni. Earring",
        back="Null Shawl",waist="Olseni Belt",legs="Jhakri Slops +2",feet="Battlecast Gaiters"})
    ...
    sets.Mode.DT = set_combine(sets.engaged, {
        head="Arbatel Bonnet +3",neck="Elite Royal Collar",lear="Alabaster Earring",
        body="Arbatel Gown +3",hands="Nyame Gauntlets",ring1="Murky Ring",ring2="Patricius Ring",
        back="Lugh's Cape",waist="Plat. Mog. Belt",legs="Arbatel Pants +3",feet="Nyame Sollerets"})
    sets.Mode.Meva = set_combine(sets.engaged, {
        head="Arbatel Bonnet +3",neck="Elite Royal Collar",lear="Etiolation Earring",rear="Eabani Earring",
        body="Arbatel Gown +3",hands="Nyame Gauntlets",ring1="Murky Ring",ring2="Vengeful Ring",
        back="Null Shawl",waist="Null Belt",legs="Arbatel Pants +3",feet="Nyame Sollerets"})
			
	-- other Sets    -- use regal once AF in place
	sets.macc = {main="Musa",sub="Khonsu",ammo="Pemphredo Tathlum",
        head="Arbatel Bonnet +3",neck="Null Loop",lear="Malignance Earring",rear="Arbatel Earring +1",
        body="Arbatel Gown +3",hands="Arbatel Bracers +3",ring1="Sangoma Ring",ring2="Metamor. Ring +1",
        back="Null Shawl",waist="Null Belt",legs="Arbatel Pants +3",feet="Arbatel Loafers +3"}
	sets.PDL = {ammo="Crepuscular Pebble"}
	sets.empy = {head="Arbatel Bonnet +3",
		body="Arbatel Gown +3",hands="Arbatel Bracers +3",
		legs="Arbatel Pants +3",feet="Arbatel Loafers +3"}		

	-- Sets with weapons defined.
	sets.engaged.Club = {}
	sets.engaged.Staff = {}
	-- sets.engaged.Club = set_combine(sets.engaged, {main="Maxentius",sub="Genmei Shield"})
	sets.engaged.Club = set_combine(sets.engaged, {main="Bunzi's Rod",sub="Ammurapi Shield"})
	...
	sets.engaged.Club.Eva = set_combine(sets.engaged.Club, sets.Mode.Eva)
	...
	sets.engaged.Staff.Eva = set_combine(sets.engaged.Staff, sets.Mode.Eva)
	...
	sets.precast.WS['Shining Strike'] = set_combine(sets.precast.WS, {
        head="Arbatel Bonnet +3",lear="Malignance Earring",rear="Friomisi Earring",
        body="Arbatel Gown +3",hands="Arbatel Bracers +3",ring1="Freke Ring",ring2="Rajas Ring",
        back="Lugh's Cape",legs="Arbatel Pants +3",feet="Artabel Loafers +3"})
    ...
    sets.precast.JA['Enlightenment'] = {legs="Peda. Gown +3"}
    sets.precast.JA['Tranquility'] = {legs="Peda. Bracers +2"}
    sets.precast.JA['Equanimity'] = {legs="Peda. Bracers +2"}
    ...
    sets.precast.FC = {main="Musa",sub="Khonsu",ammo="Incantor Stone",
        ...
        body="Shango Robe",hands="Acad. Bracers +3",ring1="Kishar Ring",ring2="Prolix Ring",
        back="Perimede Cape",waist="Embla Sash",legs="Psycloth Lappas",feet="Acad. Loafers +2"}

    sets.precast.FC['Enhancing Magic'] = set_combine(sets.precast.FC, {waist="Siegel Sash"})

    sets.precast.FC['Elemental Magic'] = set_combine(sets.precast.FC, {head="Mall. Chapeau +2",lear="Barkaro. Earring",hands="Mallquis Cuffs +2",feet="Mallquis Clogs +2"})
    ...
    sets.midcast.StatusRemoval = {
		...
		body="Peda. Gown +3",hands="Peda. Bracers +2",ring1="Ephedra Ring",legs="Acad. Pants +2",feet="Peda. Loafers +1"}
    ...
    sets.midcast.Cure = set_combine(sets.midcast.StatusRemoval, {main="Musa",sub="Khonsu",ammo="Incantor Stone",
        ...
        body="Heka's Kalasiris",hands="Peda. Bracers +2",ring1="Naji's Loop",ring2="Lebeche Ring",
    ...
    sets.midcast.Regen = {main="Musa",sub="Khonsu",
		head="Arbatel Bonnet +3",lear="Pratik Earring",
		body="Telchine Chas.",hands="Arbatel Bracers +3",
    ...
    sets.midcast['Enhancing Magic'] = {main="Musa",sub="Khonsu",ammo="Savant's Treatise",
        head="Arbatel Bonnet +3",neck="Incanter's Torque",lear="Andoaa Earring",
        body="Peda. Gown +3",hands="Telchine Gloves",
    ...
    sets.midcast['Elemental Magic'] = {main="Bunzi's Rod",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
        head="Arbatel Bonnet +3",neck="Argute Stole +2",lear="Malignance Earring",rear="Regal Earring",
        body="Arbatel Gown +3",hands="Arbatel Bracers +3",ring1="Freke Ring",ring2="Metamor. Ring +1",
        back="Lugh's Cape",waist="Sacro Cord",legs="Arbatel Pants +3",feet="Merlinic Crackows"}

    sets.midcast['Elemental Magic'].INT = set_combine(sets.midcast['Elemental Magic'], {main="Marin Staff +1",sub="Enki Strap",ammo="Ghastly Tathlum +1",
        head="Volte Beret",neck="Argute Stole +2",lear="Malignance Earring",rear="Regal Earring",
        body="Arbatel Gown +3",hands="Arbatel Bracers +3",ring1="Freke Ring",ring2="Metamor. Ring +1",
        back="Lugh's Cape",waist="Channeler's Stone",legs="Arbatel Pants +3",feet="Mallquis Clogs +2"})
    
	sets.midcast['Elemental Magic'].MAB = set_combine(sets.midcast['Elemental Magic'], {main="Bunzi's Rod",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
        head="Arbatel Bonnet +3",neck="Baetyl Pendant",lear="Malignance Earring",rear="Friomisi Earring",
        body="Arbatel Gown +3",hands="Arbatel Bracers +3",ring1="Freke Ring",ring2="Strendu Ring",
        back="Lugh's Cape",waist="Sacro Cord",legs="Arbatel Pants +3",feet="Merlinic Crackows"})
 
	-- MBB caps at 40, MBB2 no cap
	-- bunzi 10, stole 10, gown 10, bracers 15, trews 6
    sets.midcast['Elemental Magic'].MB = set_combine(sets.midcast['Elemental Magic'], {main="Bunzi's Rod",sub="Ammurapi Shield",
		head="Peda. M.Board +3",neck="Argute Stole +2",
        hands="Arbatel Bracers +3",ring2="Mujin Band",
        legs="Mallquis Trews +2",feet="Arbatel Loafers +3"})
	...
	sets.midcast['Elemental Magic'].MDmg = set_combine(sets.midcast['Elemental Magic'], {main="Bunzi's Rod",sub="Culminus",ammo="Ghastly Tathlum +1",
        head="Mall. Chapeau +2",neck="Argute Stole +2",lear="Crematio Earring",rear="Arbatel Earring +1",
        body="Mallquis Saio +2",hands="Mallquis Cuffs +2",ring1="Mallquis Ring",
        back="Lugh's Cape",legs="Mallquis Trews +2",feet="Mallquis Clogs +2"})
    ...
    -- sets.midcast.Helix = set_combine(sets.midcast['Elemental Magic'].MDmg, {neck="Argute Stole +2",back="Bookworm's Cape"})
    sets.midcast.Helix = set_combine(sets.midcast['Elemental Magic'], {neck="Argute Stole +2",back="Bookworm's Cape"})
    sets.midcast.Helix.Luminohelix = set_combine(sets.midcast.Helix, {main="Daybreak",sub="Culminus"})
    sets.midcast.Helix.Noctohelix = set_combine(sets.midcast.Helix, {head="Pixie Hairpin +1"})

	-- Custom spell classes 
    sets.midcast.ElementalEnfeeble = set_combine(sets.midcast['Elemental Magic'].INT, {})
	...
	sets.midcast.Enfeebling.Skill = set_combine(sets.macc, {ammo="Savant's Treatise",
        head="Befouled Crown",neck="Incanter's Torque",
        body="Acad. Gown +3",hands="Peda. Bracers +2",ring2="Globidonta Ring",
        waist="Rumination Sash",legs="Arbatel Pants +3",feet="Medium's Sabots"})
    ...
    sets.midcast['Dark Magic'] = set_combine(sets.midcast['Elemental Magic'].Macc, {
        body="Acad. Gown +3",neck="Erra Pendant",ring1="Evanescence Ring",ring2="Kishar Ring",
        back="Bookworm's Cape",legs="Peda. Pants +3"})
    ...
    sets.midcast.Drain = set_combine(sets.midcast['Dark Magic'],{
		...
		head="Merlinic Hood",neck="Erra Pendant",
		ring2="Excelsis Ring",
		waist="Fucho-no-obi",legs="Peda. Pants +3",feet="Merlinic Crackows"})

    sets.midcast.Aspir = set_combine(sets.midcast.Drain, {})

    sets.midcast.Stun = {ammo="Incantor Stone",
        neck="Sanctity Necklace",lear="Psystorm Earring",rear="Lifestorm Earring",
        back="Kumbira Cape",legs="Peda. Pants +3",feet="Acad. Loafers +2"}
    ...
    sets.buff['Altruism'] = {head="Peda. M.Board +3"}
    ...
    sets.buff['Immanence'] = {
		...
		body="Nyame Mail",hands="Arbatel Bracers +3",ring1="Mujin Band",
		back="Lugh's Cape",legs="Nyame Flanchard",feet=""}
    ...
    sets.buff.FullSublimation = {head="Acad. Mortar. +3",body="Peda. Gown +3",waist="Embla Sash"}
		...
		if spell.skill == 'Elemental Magic' then
			if spell.name:match('helix') then
				if spell.name:match('Luminohelix') then
					equip(sets.midcast.Helix.Luminohelix)
				elseif spell.name:match('Noctohelix') then
					equip(sets.midcast.Helix.Noctohelix)
				else	
...
function job_self_command(cmdParams, eventArgs)
    ...
    if cmdParams[1]:lower() == 'drop' then
        drop_wing(cmdParams)
        eventArgs.handled = true
    end
end
