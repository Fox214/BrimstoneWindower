...
function init_gear_sets()
	...
	sets.engaged = { ammo="Crepuscular Pebble",
		head="Nyame Helm",neck="Null Loop",lear="Alabaster Earring",rear="Chev. Earring +1",
		body="Sacro Breastplate",hands="Nyame Gauntlets",ring1="Patricius Ring",ring2="Moonbeam Ring",
		back="Null Shawl",waist="Sarissapho. Belt",legs="Nyame Flanchard",feet="Nyame Sollerets"}
			
	-- Basic Mode definitions
	sets.Mode = {}
	sets.Mode.Acc = set_combine(sets.engaged, {
        head="Flam. Zucchetto +2",neck="Null Loop",lear="Zennaroi Earring",rear="Chev. Earring +1",
    ...
    sets.Mode.DT = set_combine(sets.engaged, { ammo="Crepuscular Pebble",
        head="Nyame Helm",neck="Elite Royal Collar",lear="Alabaster Earring",rear="Chev. Earring +1",
    ...
    sets.Mode.HP = set_combine(sets.engaged, {
        head="Nyame Helm",neck="Null Loop",lear="Alabaster Earring",rear="Eabani Earring",
        body="Sacro Breastplate",hands="Nyame Gauntlets",ring1="Murky Ring",ring2="Moonbeam Ring",
    ...
    sets.Mode.Charm = {ammo="Iron Gobbet",
        ...
        body="Reverence Surcoat +1",hands="Reverence Gauntlets +1",ring1="Murky Ring",
	...
	sets.engaged.Grip.GreatSword = set_combine(sets.engaged, {main="Tunglmyrkvi",sub="Bloodrain Strap"})
	sets.engaged.Grip.Polearm = set_combine(sets.engaged, {main="Shining One", sub="Bloodrain Strap"})
	sets.engaged.Grip.Staff = set_combine(sets.engaged, {main="Malignance Pole", sub="Bloodrain Strap"})
    ...
    sets.precast.WS['Atonement'] = {ammo="Oshasha's Treatise",
        head="Reverence Coronet +1",lear="Creed Earring",rear="Steelflash Earring",
    ...
    sets.precast.Waltz = {ammo="Sonia's Plectrum",
        head="Reverence Coronet +1",
        body="Nyame Mail",hands="Reverence Gauntlets +1",
