...
function init_gear_sets()   
	...
	sets.idle = {
        ...
        back="Solemnity Cape",waist="Null Belt",legs="Nyame Flanchard",feet="Skd. Jambeaux +1"}
	...
	-- Normal melee group
    sets.engaged = {
        head="Malignance Chapeau",neck="Null Loop",lear="Odr Earring",rear="Skulk. Earring +1",
        body="Meg. Cuirie +2",hands="Herculean Gloves",ring1="Epona's Ring",ring2="Hetairoi Ring",
        back="Null Shawl",waist="Sarissapho. Belt",legs="Meg. Chausses +2",feet="Herculean Boots"}
	...
	sets.Mode.Acc = set_combine(sets.engaged, {
        ...
        back="Null Shawl",waist="Null Belt",legs="Meg. Chausses +2",feet="Meg. Jam. +2"})
	...
	sets.Mode.sTP = set_combine(sets.engaged, {
        ...
        body="Ashera Harness",ring1="Rajas Ring",ring2="K'ayres Ring",
        back="Lupine Cape",waist="Olseni Belt",legs="Iuitl Tights",feet="Mummu Gamash. +2"})
	sets.Mode.STR = set_combine(sets.engaged, {
        head="Lilitu Headpiece",neck="Rep. Plat. Medal",lear="Sherida Earring",
        body="Nyame Mail",hands="Meg. Gloves +2",ring1="Aife's Ring",ring2="Regal Ring",
	...
	-- other Sets    
	sets.macc = {
		head="Malignance Chapeau",neck="Null Loop",lear="Digni. Earring",rear="Crep. Earring",
		ring1="Sangoma Ring",
		back="Null Shawl",waist="Null Belt",legs="Nyame Flanchard",feet="Nyame Sollerets"}
	...
	sets.engaged.DW.Dagger.Meva = set_combine(sets.engaged.DW.Dagger, sets.Mode.Meva)	sets.engaged.Shield.Dagger.Acc = set_combine(sets.engaged.Shield.Dagger, sets.Mode.Acc)
	...
	sets.engaged.Shield.Dagger.Meva = set_combine(sets.engaged.Shield.Dagger, sets.Mode.Meva)	sets.engaged.TH.Dagger.Acc = set_combine(sets.engaged.TH.Dagger, sets.Mode.Acc)
	...
	sets.engaged.TH.Dagger.Eva = set_combine(sets.engaged.TH.Dagger, sets.Mode.Eva)
	sets.engaged.TH.Dagger.DT = set_combine(sets.engaged.TH.Dagger, sets.Mode.DT)
	sets.engaged.TH.Dagger.Meva = set_combine(sets.engaged.TH.Dagger, sets.Mode.Meva)
	...
	sets.engaged.TH.Staff = set_combine(sets.engaged, {main="Gozuki Mezuki",sub="Bloodrain Strap"})
	...
	sets.engaged.TH.Polearm = set_combine(sets.engaged, {main="Pitchfork +1",sub="Bloodrain Strap"})
	...
	sets.engaged.TH.Scythe = set_combine(sets.engaged, {main="Ark Scythe",sub="Bloodrain Strap"})
    ...
    sets.buff['Sneak Attack'] = {
        ...
        body="Meg. Cuirie +2",hands="Skulk. Armlets +1",ring1="Ilabrat Ring",ring2="Apate Ring",
    ...
    sets.buff['Trick Attack'] = {
        ...
        body="Meg. Cuirie +2",hands="Pill. Armlets +1",ring1="Ilabrat Ring",ring2="Apate Ring",
    ...
    sets.precast.Waltz = {
        head="Nyame Helm",
        body="Nyame Mail",hands="Buremte Gloves",ring2="Metamor. Ring +1",
        legs="Nyame Flanchard",feet="Meg. Jam. +2"}
	...
	sets.precast.WS['Cyclone'] = set_combine(sets.precast.WS, {
        head="Nyame Helm",lear="Friomisi Earring",rear="Crematio Earring",
	...
	sets.midcast['Elemental Magic'] = set_combine(sets.TreasureHunter, {
		neck="Incanter's Torque",lear="Friomisi Earring",rear="Crematio Earring",
		body="Nyame Mail",ring1="Patricius Ring",ring2="Metamor. Ring +1",
		back="Toro Cape",legs="Nyame Flanchard"})
