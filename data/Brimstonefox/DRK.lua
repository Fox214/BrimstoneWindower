...
function init_gear_sets()
	...
	sets.idle = {head="Null Masque",neck="Elite Royal Collar",lear="Alabaster Earring",rear="Moonshade Earring",
		body="Sacro Breastplate",hands="Nyame Gauntlets",ring1="Murky Ring",ring2="Patricius Ring",
	...
	sets.engaged = { 
		...
		back="Null Shawl",waist="Ioskeha Belt",legs="Sulev. Cuisses +2",feet="Flam. Gambieras +2"}
			
	-- Basic Mode definitions
	sets.Mode = {}
	sets.Mode.Acc = set_combine(sets.engaged, {
        head="Flam. Zucchetto +2",neck="Null Loop",lear="Zennaroi Earring",rear="Heath. Earring +1",
        body="Valorous Mail",hands="Emicho Gauntlets",ring1="Cacoethic Ring +1",ring2="Regal Ring",
        back="Null Shawl",waist="Null Belt",legs="Carmine Cuisses +1",feet="Flam. Gambieras +2"})
	...
	sets.Mode.sTP = set_combine(sets.engaged, {
        ...
        back="Null Shawl",legs="Phorcys Dirs",feet="Flam. Gambieras +2"})
	sets.Mode.STR = set_combine(sets.engaged, {
        head="Flam. Zucchetto +2",neck="Rep. Plat. Medal",lear="Thrud Earring",
        body="Ignominy Cuirass +2",hands="Regal Cpt. Gloves",ring1="Niqmaddu Ring",ring2="Regal Ring",
	...
	sets.Mode.Eva = set_combine(sets.engaged, {
        ...
        body="Nyame Mail",waist="Null Belt",hands="Nyame Gauntlets",ring1="Vengeful Ring",ring2="Beeline Ring",
	...
	-- other Sets    
	sets.macc = {
		head="Nyame Helm",neck="Null Loop",lear="Malignance Earring",rear="Crep. Earring",
		body="Nyame Mail",hands="Nyame Gauntlets",ring1="Sangoma Ring",
		back="Null Shawl",waist="Null Belt",legs="Nyame Flanchard",feet="Nyame Sollerets"}
	sets.PDL = {}
	sets.empy = {head="Heathen's Burgeonet",
	...
	sets.engaged.Grip.GreatAxe = set_combine(sets.engaged, {main="Ixtab",sub="Utu Grip"})
	sets.engaged.Grip.GreatSword = set_combine(sets.engaged, {main="Zulfiqar",sub="Utu Grip"})
	sets.engaged.Grip.Scythe = set_combine(sets.engaged, {main="Deathbane", sub="Utu Grip"})
	sets.engaged.Grip.Staff = set_combine(sets.engaged, {main="Gozuki Mezuki", sub="Utu Grip"})
    ...
    sets.precast.FC = { 
		neck="Orunmila's Torque",lear="Malignance Earring",rear="Etiolation Earring",
	...
	sets.midcast['Elemental Magic'] = set_combine(sets.macc, {
        head="Nyame Helm",neck="Sanctity Necklace",lear="Malignance Earring",rear="Friomisi Earring",
	...
	sets.midcast.Enfeebling.Skill = set_combine(sets.macc, {
        ...
        body="Ignominy Cuirass +2",ring2="Globidonta Ring"})
	sets.midcast.Enfeebling.MND = {}
	sets.midcast.Enfeebling.INT = {}
	sets.midcast.Enfeebling.effect = {}
    ...
    sets.midcast['Dark Magic'] = set_combine(sets.macc, {
        ...
        hands="Fall. Fin. Gaunt. +1",ring1="Evanescence Ring",ring2="Kishar Ring"})
