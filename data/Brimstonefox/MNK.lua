...
function user_setup()
	state.OffenseMode:options('Normal', 'Acc', 'Att', 'Crit', 'DA', 'SB', 'sTP', 'STR', 'Eva', 'DT', 'Meva', 'HP', 'Counter')
...
function init_gear_sets()
    ...
    sets.idle = {ammo="Amar Cluster",
        ...
        back="Solemnity Cape",waist="Null Belt",legs="Nyame Flanchard",feet="Herald's Gaiters"}
    ...
    sets.engaged = {ammo="Coiste Bodhar",
        head="Hizamaru Somen +2",neck="Combatant's Torque",lear="Schere Earring",rear="Bhikku Earring +2",
        body="Tatena. Harama. +1",hands="Tatena. Gote +1",ring1="Niqmaddu Ring",ring2="Epona's Ring",
        back="Segomo's Mantle",waist="Black Belt",legs="Mpaca's Hose",feet="Mpaca's Boots"}
	
	-- Basic Mode definitions
	sets.Mode = {}
	sets.Mode.Acc = set_combine(sets.engaged, { ammo="Mantoptera Eye",
		head="Malignance Chapeau",neck="Null Loop",lear="Zennaroi Earring",rear="Bhikku Earring +2",
		body="Hiza. Haramaki +2",hands="Tatena. Gote +1",ring1="Cacoethic Ring +1",ring2="Regal Ring",
		back="Null Shawl",waist="Null Belt",legs="Mummu Kecks +2",feet="Mummu Gamash. +2"})
	sets.Mode.Att= set_combine(sets.engaged, {ammo="Knobkierrie",
		...
		back="Phalangite Mantle",waist="Eschan Stone",legs="Nyame Flanchard",feet="Nyame Sollerets"})
	...
	sets.Mode.DA = set_combine(sets.engaged, { ammo="Coiste Bodhar",
		head="Skormoth Mask",neck="Asperity Necklace",lear="Schere Earring",rear="Sherida Earring",
		body="Bhikku Cyclas",hands="Herculean Gloves",ring1="Niqmaddu Ring",ring2="Epona's Ring",
		back="Null Shawl",waist="Sinew Belt",legs="Mpaca's Hose",feet="Mpaca's Boots"})
	sets.Mode.SB = set_combine(sets.engaged, {head="Bhikku Crown",lear="Schere Earring",rear="Sherida Earring",
	...
	sets.Mode.sTP = set_combine(sets.engaged, { ammo="Coiste Bodhar",
		...
		body="Ashera Harness",hands="Otronif Gloves +1",ring1="Rajas Ring",ring2="Ilabrat Ring",
		back="Null Shawl",waist="Yemaya Belt",legs="Hes. Hose",feet="Otronif Boots"})
	sets.Mode.STR = set_combine(sets.engaged, {ammo="Knobkierrie",
		head="Mpaca's Cap",neck="Rep. Plat. Medal",lear="Schere Earring",rear="Bhikku Earring +2",
		body="Hiza. Haramaki +2",hands="Regal Cpt. Gloves",ring1="Niqmaddu Ring",ring2="Regal Ring",
		back="Segomo's Mantle",waist="Cornelia's Belt",legs="Hiza. Hizayoroi +2",feet="Mpaca's Boots"})
	sets.Mode.HP = set_combine(sets.engaged, {
        head="Null Masque",neck="Null Loop",lear="Etiolation Earring",rear="Eabani Earring",
        body="Nyame Mail",hands="Hesychast's Gloves +1",ring1="K'ayres Ring",ring2="Overbearing Ring",
        back="Anchoret's Mantle",waist="Plat. Mog. Belt",legs="Nyame Flanchard",feet="Nyame Sollerets"})
    sets.Mode.Counter = set_combine(sets.engaged, {ammo="Amar Cluster",
        body="Sweller's Harness",hands="Count's Cuffs",rear="Bhikku Earring +2",
        back="Anchoret's Mantle",legs="Anchorite's Hose",feet="Hes. Gaiters"})
	sets.Mode.Eva = set_combine(sets.engaged, { ammo="Amar Cluster",
		head="Null Masque",lear="Infused Earring",rear="Eabani Earring",
		body="Nyame Mail",hands="Mpaca's Gloves",ring1="Vengeful Ring",ring2="Beeline Ring",
    ...
    sets.Mode.DT = set_combine(sets.engaged, { ammo="Crepuscular Pebble",
        ...
        back="Solemnity Cape",waist="Black Belt",legs="Nyame Flanchard",feet="Nyame Sollerets"})
	...
	-- other Sets    
	sets.macc = {
		head="Null Masque",neck="Null Loop",lear="Crep. Earring",rear="Bhikku Earring +2",
		body="Nyame Mail",hands="Nyame Gauntlets",ring1="Sangoma Ring",
		back="Null Shawl",legs="Nyame Flanchard",feet="Nyame Sollerets"}
	sets.PDL = {ammo="Crepuscular Pebble",head="Malignance Chapeau"}
	...
	sets.engaged.Staff = {}
	sets.engaged.Club = {}
	sets.engaged.H2H = set_combine(sets.engaged, {main="Godhands"})
	...
	sets.engaged.H2H.HP = set_combine(sets.engaged.H2H, sets.Mode.HP)
	sets.engaged.H2H.Counter = set_combine(sets.engaged.H2H, sets.Mode.Counter)
    ...
    sets.precast.JA['Chi Blast'] = {
        ...
        body="Nyame Mail",hands="Nyame Gauntlets",ring1="Globidonta Ring",ring2="Metamor. Ring +1",
        waist="Rumination Sash",legs="Nyame Flanchard",feet="Nyame Sollerets"}

	-- VIT
    sets.precast.JA['Chakra'] = {ammo="Tantra Tathlum",
        head="Hizamaru Somen +2",
        body="Anchorite's Cyclas",hands="Nyame Gauntlets",
        legs="Hiza. Hizayoroi +2",feet="Nyame Sollerets"}

    -- Waltz set (chr and vit)
    sets.precast.Waltz = {ammo="Tantra Tathlum",
        head="Nyame Helm",
        body="Nyame Mail",hands="Nyame Gauntlets",ring1="Angel's Ring",ring2="Metamor. Ring +1",
        waist="Chaac Belt",legs="Nyame Flanchard",feet="Nyame Sollerets"}
	...
	sets.precast.WS = set_combine(sets.Mode.STR, {ammo="Knobkierrie",
        ...
        body="Herculean Vest",hands="Anchor. Gloves +2",ring1="Cornelia's Ring",ring2="Epaminondas's Ring",
    ...
    -- Defense sets
	sets.defense.HP = set_combine(sets.Mode.HP, {})
	sets.defense.Counter = set_combine(sets.Mode.Counter, {})
