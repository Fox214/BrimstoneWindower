...
function init_gear_sets()
    ...
    gear.magBack = { name="Campestres's Cape", augments={'Pet: M.Acc.+20 Pet: M.Dmg.+20','Eva.+20 /Mag. Eva.+20','Pet: Mag. Acc.+10','"Fast Cast"+10','Damage taken-5%',}}
    gear.physBack = { name="Campestres's Cape", augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Eva.+20 /Mag. Eva.+20','Pet: Attack+10 Pet: Rng.Atk.+10','Pet: Haste+10','Pet: Damage taken -5%',}}
    --------------------------------------
    ...
    sets.idle = {ammo="Sancus Sachet +1",
        head="Beckoner's Horn +2",neck="Elite Royal Collar",lear="Moonshade Earring",rear="Beck. Earring +1",
        body="Apogee Dalmatica",hands="Telchine Gloves",ring1="Murky Ring",ring2="Renaye Ring +1",
        back=gear.magBack,waist="Fucho-no-Obi",legs="Assid. Pants +1",feet="Herald's Gaiters"}
	...
	sets.perp.base = {main="Nirvana",sub="Oneiros Grip",
		head="Glyphic Horn +2",lear="Evans Earring",rear="Beck. Earring +1",
		body="Glyphic Doublet",ring1="Evoker's Ring",
		back=gear.physBack,legs="Assid. Pants +1",feet="Apogee Pumps +1"}
	...
	sets.skill.smn = {main="Exemplar",sub="Vox Grip",
        head="Convoker's Horn +3",neck="Incanter's Torque",lear="Andoaa Earring",rear="Beck. Earring +1",
        body="Beckoner's Doublet",hands="Glyphic Bracers +1",ring1="Evoker's Ring",ring2="Globidonta Ring",
        back="Conveyance Cape",waist="Summoning Belt",legs="Beck. Spats +2",feet="Rubeus Boots"}
 
	-- Favor uses Caller's Horn instead of Convoker's Horn +3 for refresh
    sets.idle.Avatar.Favor = set_combine(sets.skill.smn, sets.perp.base, {head="Beckoner's Horn +2"})
    sets.idle.Avatar.Melee = {
		head="Beckoner's Horn +2",neck="Smn. Collar +2",lear="Enmerkar Earring",rear="Beck. Earring +1",
		body="Nyame Mail",hands="Nyame Gauntlets",ring2="Tali'ah Ring",
		back=gear.physBack,waist="Incarnation Sash",legs="Tali'ah Sera. +2",feet="Tali'ah Crackows +2"}
    ...
    sets.engaged = {ammo="Sancus Sachet +1",
        head="Beckoner's Horn +2",neck="Smn. Collar +2",lear="Bladeborn Earring",rear="Steelflash Earring",
        body="Con. Doublet +3",hands="Tali'ah Gages +2",ring1="Evoker's Ring",ring2="Renaye Ring +1",
        back="Null Shawl",waist="Null Belt",legs="Beck. Spats +2",feet="Tali'ah Crackows +2"}
	
	-- Basic Mode definitions
	sets.Mode = {}
	sets.Mode.Acc = set_combine(sets.engaged, {
		head="Beckoner's Horn +2",neck="Shulmanu Collar",lear="Zennaroi Earring",rear="Digni. Earring",
	...
	sets.Mode.Att= set_combine(sets.engaged, {
		...
		body="Nyame Mail",hands="Nyame Gauntlets",ring1="Overbearing Ring",ring2="Cho'j Band",
	...
	sets.Mode.sTP = set_combine(sets.engaged, {
		neck="Combatant's Torque",lear="Crep. Earring",rear="Tripudio Earring",
		ring1="Rajas Ring",ring2="K'ayres Ring",
		back="Null Shawl",waist="Olseni Belt"})
	...
	-- other Sets    
	sets.macc = {main="Bunzi's Rod","Ammurapi Shield",
		head="Beckoner's Horn +2",neck="Null Loop",lear="Malignance Earring",rear="Digni. Earring",
		body="Nyame Mail",hands="Nyame Gauntlets",ring1="Sangoma Ring",
		back="Null Shawl",waist="Null Belt",legs="Beck. Spats +2",feet="Nyame Sollerets"}
	sets.PDL = {}
	sets.empy = {head="Beckoner's Horn +2",
		body="Beckoner's Doublet",hands="Beckoner's Bracers",
		legs="Beck. Spats +2",feet="Beck. Pigaches"}
    ...
    sets.precast.BloodPactWard = set_combine(sets.skill.smn, {main="Nirvana",sub="Vox Grip",ammo="Sancus Sachet +1",
		head="Beckoner's Horn +2",lear="Evans Earring",rear="Beck. Earring +1",
		body="Apogee Dalmatica",hands="Glyphic Bracers +1",ring2="Tali'ah Ring",
        back="Conveyance Cape",legs="Glyphic Spats +1",feet="Glyph. Pigaches +2"})
    ...
    sets.precast.FC = {
        ...
        back=gear.magBack,waist="Embla Sash",legs="Psycloth Lappas",feet="Merlinic Crackows"}
    ...
    sets.midcast.Cure = {main="Bunzi's Rod",sub="Genmei Shield",
	...
	sets.midcast['Enhancing Magic'] = {
		main="Bolelabunga",sub="Ammurapi Shield",neck="Incanter's Torque",lear="Andoaa Earring",
    ...
    sets.midcast.Pet.DebuffBloodPactWard = set_combine(sets.skill.smn, {ammo="Sancus Sachet +1",
        head="Convoker's Horn +3",neck="Caller's Pendant",lear="Enmerkar Earring",rear="Beck. Earring +1",
        body="Beckoner's Doublet",hands="Glyphic Bracers +1"})
    ...
    sets.midcast.Pet.PhysicalBloodPactRage = set_combine(sets.skill.smn, {main="Nirvana",sub="Elan Strap +1",ammo="Sancus Sachet +1",
        head="Apogee Crown +1",neck="Smn. Collar +2",lear="Gelos Earring",rear="Beck. Earring +1",
        body="Con. Doublet +3",hands="Beckoner's Bracers",ring2="Tali'ah Ring",
        back=gear.physBack,waist="Incarnation Sash",legs="Apogee Slacks +1",feet="Apogee Pumps +1"})
    ...
    sets.midcast.Pet.MagicalBloodPactRage = set_combine(sets.skill.smn, {main=gear.pet_staff,ammo="Sancus Sachet +1",
        head="Apogee Crown +1",neck="Smn. Collar +2",lear="Enmerkar Earring",rear="Beck. Earring +1",
        body="Apogee Dalmatica",hands="Merlinic Dastanas",
        back=gear.magBack,waist="Incarnation Sash",legs="Apogee Slacks +1",feet="Apogee Pumps +1"})

    sets.midcast.Pet.MagicalBloodPactRage.Acc = set_combine(sets.midcast.Pet.MagicalBloodPactRage, {legs="Glyphic Spats +1"})
