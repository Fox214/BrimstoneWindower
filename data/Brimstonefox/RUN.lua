...
function init_gear_sets()
	...
	sets.idle = { ammo="Homiliary",
		...
		body="Vrikodara Jupon",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="Renaye Ring +1",
		back="Evasionist's Cape",waist="Null Belt",legs="Carmine Cuisses +1",feet="Nyame Sollerets"}
	...
	sets.engaged = {ammo="Yamarang",
        head="Nyame Helm",neck="Null Loop",lear="Alabaster Earring",rear="Erilaz Earring +1",
        body="Nyame Mail",hands="Nyame Gauntlets",ring1="Niqmaddu Ring",ring2="Moonbeam Ring",
        back="Null Shawl",waist="Null Belt",legs="Nyame Flanchard",feet="Nyame Sollerets"}
			
	-- Basic Mode definitions
	sets.Mode = {}
	sets.Mode.Acc = set_combine(sets.engaged, { ammo="Yamarang",
        head="Meghanada Visor +2",neck="Null Loop",lear="Zennaroi Earring",rear="Crep. Earring",
	...
	sets.Mode.DA = set_combine(sets.engaged, {
        ...
        back="Null Shawl",waist="Ioskeha Belt",legs="Meg. Chausses +2",feet="Thaumas Nails"})
	sets.Mode.SB = set_combine(sets.engaged, {})
	sets.Mode.sTP = set_combine(sets.engaged, { ammo="Yamarang",
        head="Aya. Zucchetto +2",neck="Anu Torque",lear="Sherida Earring",rear="Crep. Earring",
        body="Ashera Harness",hands="Umuthi Gloves",ring1="Ilabrat Ring",ring2="Rajas Ring",
        back="Null Shawl",waist="Yemaya Belt",legs="Herculean Trousers"})
	...
	sets.Mode.DT = set_combine(sets.engaged, { ammo="Crepuscular Pebble",
		head="Nyame Helm",neck="Elite Royal Collar",lear="Alabaster Earring",rear="Erilaz Earring +1",
		body="Nyame Mail",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="Patricius Ring",
		back="Evasionist's Cape",waist="Plat. Mog. Belt",legs="Nyame Flanchard",feet="Nyame Sollerets"})
	sets.Mode.Meva = set_combine(sets.engaged, {
		head="Nyame Helm",neck="Elite Royal Collar",lear="Etiolation Earring",rear="Erilaz Earring +1",
		body="Nyame Mail",hands="Nyame Gauntlets",ring1="Defending Ring",ring2="Moonbeam Ring",
		back="Null Shawl",waist="Null Belt",legs="Nyame Flanchard",feet="Nyame Sollerets"})
			
	-- other Sets    
	sets.macc = {
		head="Nyame Helm",neck="Null Loop",rear="Digni. Earring",rear="Crep. Earring",
	...
	sets.empy = {head="Erilaz Galea",
		...
		legs="Erilaz Leg Guards",feet="Erilaz Greaves"}		
    ...
    sets.midcast['Phalanx'] = set_combine(sets.midcast['Enhancing Magic'],{head="Fu. Bandeau +1"})
