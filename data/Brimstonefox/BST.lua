...
function user_setup()
	...
	state.OffenseMode:options('Normal', 'Acc', 'Att', 'Crit', 'DA', 'SB', 'SB', 'sTP', 'STR', 'Eva', 'DT', 'Meva')
...
function init_gear_sets()
	...
	sets.idle = {ammo="Demonry Core",
        ...
        body="Sacro Breastplate",hands="Nyame Gauntlets",ring1="Murky Ring",ring2="Renaye Ring +1",
    ...
    sets.idle.Pet.Offensive = set_combine(sets.idle.Pet, {ammo="Demonry Core",
        head="Nyame Helm",neck="Shulmanu Collar",lear="Enmerkar Earring",rear="Crep. Earring",
        body="Nyame Mail",hands="Nyame Gauntlets",ring1="Murky Ring",ring2="Tali'ah Ring",
	...
	sets.engaged = {ammo="Demonry Core",
		head="Valorous Mask",neck="Shulmanu Collar",lear="Crep. Earring",rear="Nukumi Earring +1",
		body="Nyame Mail",hands="Nyame Gauntlets",ring1="Epona's Ring",ring2="Hetairoi Ring",
		back="Artio's Mantle",waist="Hurch'lan Sash",legs="Nyame Flanchard",feet="Tali'ah Crackows +2"}
	sets.engaged.Killer = set_combine(sets.engaged, {body="Nukumi Gausape"})
			
	-- Basic Mode definitions
	sets.Mode = {}
	sets.Mode.Acc = set_combine(sets.engaged, {
		head="Tali'ah Turban +2",neck="Null Loop",lear="Zennaroi Earring",rear="Nukumi Earring +1",
		body="Meg. Cuirie +2",hands="Emicho Gauntlets",ring1="Cacoethic Ring +1",ring2="Regal Ring",
		back="Artio's Mantle",waist="Null Belt",legs="Meg. Chausses +2",feet="Meg. Jam. +2"})
	sets.Mode.Att= set_combine(sets.engaged, {
		head="Meghanada Visor +2",neck="Rep. Plat. Medal",lear="Bladeborn Earring",rear="Dudgeon Earring",
		body="Phorcys Korazin",hands="Meg. Gloves +2",ring1="Ilabrat Ring",ring2="Regal Ring",
	...
	sets.Mode.DA = set_combine(sets.engaged, {
		head="Skormoth Mask",neck="Shulmanu Collar",lear="Brutal Earring",rear="Sherida Earring",
		body="Tali'ah Manteel +2",hands="Phorcys Mitts",ring1="Epona's Ring",ring2="Hetairoi Ring",
		back="Null Shawl",waist="Sarissapho. Belt",legs="Meg. Chausses +2",feet="Loyalist Sabatons"})
	sets.Mode.SB = set_combine(sets.engaged, {body="Sacro Breastplate"})
	sets.Mode.sTP = set_combine(sets.engaged, {
		head="Tali'ah Turban +2",neck="Anu Torque",lear="Crep. Earring",rear="Sherida Earring",
		body="Valorous Mail",ring1="Ilabrat Ring",ring2="Rajas Ring",
		back="Null Shawl",waist="Yemaya Belt",legs="Phorcys Dirs",feet="Valorous Greaves"})
	...
	sets.engaged.Grip.Scythe = set_combine(sets.engaged, {main="Pixquizpan", sub="Bloodrain Strap"})
	...
	sets.precast.WS = set_combine(sets.Mode.STR, {ammo="Oshasha's Treatise",
		neck="Fotia Gorget",lear="Thrud Earring",rear="Nukumi Earring +1",
    ...
    sets.precast.JA['Bestial Loyalty'] = {main="Skullrender",ammo=gear.Broth,rear="Nukumi Earring +1",hands="Ankusa Gloves +1"}
    ...
    -- CURING WALTZ
    sets.precast.Waltz = {
        head="Nyame Helm",neck="Ferine Necklace",
        body="Tot. Jackcoat +1",hands="Nyame Gauntlets",ring2="Metamor. Ring +1",
