...
--[[
	...
	HordeMode cycles between String and Wind instruments for Horde Lullaby (string has great AoE Range)
--]]
...
function job_setup()
	...
	state.HordeMode = M{['description']='Horde Mode', 'Wind', 'String'}
...
function init_gear_sets()
	...
	sets.idle = {main="Sangoma",sub="Genmei Shield",range="Terpander",
		head="Null Masque",neck="Elite Royal Collar",lear="Alabaster Earring",rear="Fili Earring +2",
		body="Vrikodara Jupon",hands="Telchine Gloves",ring1="Murky Ring",ring2="Renaye Ring +1",
		back="Solemnity Cape",waist="Null Belt",legs="Nyame Flanchard",feet="Fili Cothurnes +1"}
	...
	sets.engaged = {
		head="Aya. Zucchetto +2",neck="Null Loop",lear="Crep. Earring",rear="Fili Earring +2",
		body="Ashera Harness",hands="Aya. Manopolas +2",ring1="Patricius Ring",ring2="Hetairoi Ring",
	...
	sets.Mode.DA = set_combine(sets.engaged, {neck="Asperity Necklace", lear="Trux Earring",rear="Brutal Earring",
        body="Ayanmo Corazza +2",ring2="Hetairoi Ring",
		back="Null Shawl",waist="Sarissapho. Belt",legs="Zoar Subligar"})
	...
	sets.Mode.sTP = set_combine(sets.engaged, {
		...
		body="Ashera Harness",ring1="Ilabrat Ring",ring2="Rajas Ring",
		back="Null Shawl",waist="Yemaya Belt"})
	...
	sets.Mode.DT = set_combine(sets.engaged, {
		head="Nyame Helm",neck="Elite Royal Collar",lear="Alabaster Earring",rear="Fili Earring +2",
	...
	sets.macc = {main="Marin Staff +1",sub="Enki Strap",
		head="Nyame Helm",neck="Null Loop",lear="Regal Earring",rear="Fili Earring +2",
		body="Ayanmo Corazza +2",hands="Inyan. Dastanas +2",ring1="Sangoma Ring",ring2="Metamor. Ring +1",
		back="Null Shawl",waist="Null Belt",legs="Nyame Flanchard",feet="Brioso Slippers +3"}
	sets.PDL = {}
	...
	sets.engaged.Dagger.DT = set_combine(sets.engaged.Dagger, sets.Mode.DT)
	sets.engaged.Dagger.Meva = set_combine(sets.engaged.Dagger, sets.Mode.Meva)
	...
	sets.CHR = {main="Chatoyant Staff",
		head="Inyanga Tiara +2",neck="Moonbow Whistle",lear="Regal Earring",rear="Fili Earring +2",
	...
	sets.Wind = set_combine(sets.Singing, {
		...
		back="Rhapsode's Cape",legs="Brioso Cannions",feet="Brioso Slippers +3"}) 
	...
	sets.midcast.LullabyString = set_combine(sets.String, {range="Terpander",hands="Brioso Cuffs +1"})
...
function job_midcast(spell, action, spellMap, eventArgs)
	...
	if spell.action_type == 'Magic' then
		...
		if state.HordeMode.value == 'String' then
			if spell.name == 'Horde Lullaby' or spell.name == spell.name == 'Horde Lullaby II' then
				equip(sets.midcast.LullabyString)
			end
		end	
	end
end
