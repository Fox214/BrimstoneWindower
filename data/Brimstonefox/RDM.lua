...
function init_gear_sets()
    ...
    sets.idle = {ammo="Homiliary",
        head="Viti. Chapeau +1",neck="Elite Royal Collar",lear="Alabaster Earring",rear="Moonshade Earring",
    ...
    sets.engaged = { ammo="Coiste Bodhar",
        head="Null Masque",neck="Null Loop",lear="Sherida Earring",rear="Brutal Earring",
        body="Ayanmo Corazza +2",hands="Aya. Manopolas +2",ring1="Patricius Ring",ring2="Apate Ring",
        back="Null Shawl",waist="Sailfi Belt +1",legs="Carmine Cuisses +1",feet="Aya. Gambieras +2"}
	...
	sets.Mode.Att= set_combine(sets.engaged, {
        ...
        body="Jhakri Robe +2",hands="Jhakri Cuffs +2",ring1="Overbearing Ring",ring2="Ilabrat Ring",
	...
	sets.Mode.DA = set_combine(sets.engaged, { ammo="Coiste Bodhar",
		...
		back="Null Shawl",legs="Zoar Subligar"})
	sets.Mode.SB = set_combine(sets.engaged, {})
	sets.Mode.sTP = set_combine(sets.engaged, { ammo="Coiste Bodhar",
        head="Malignance Chapeau",neck="Anu Torque",lear="Sherida Earring",rear="Crep. Earring",
        back="Null Shawl",legs="Jhakri Slops +2",ring2="Ilabrat Ring"})
	...
	sets.macc = {main="Bunzi's Rod",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
        head="Malignance Chapeau",neck="Null Loop",lear="Malignance Earring",rear="Leth. Earring +1",
        body="Jhakri Robe +2",hands="Jhakri Cuffs +2",ring1="Sangoma Ring",ring2="Metamor. Ring +1",
        back="Null Shawl",waist="Null Belt",legs="Merlinic Shalwar",feet="Jhakri Pigaches +2"}
    ...
    sets.precast.FC = {
        head="Atrophy Chapeau +1",neck="Orunmila's Torque",lear="Malignance Earring",rear="Leth. Earring +1",
        body="Viti. Tabard +1",ring1="Kishar Ring",ring2="Prolix Ring",
    ...
    sets.midcast.Healing = {
		neck="Incanter's Torque",body="Viti. Tabard +1"}
		
    sets.midcast.Cure = set_combine(sets.midcast.Healing,  {main="Bunzi's Rod",sub="Genmei Shield",
    ...
    sets.midcast['Enhancing Magic'] = { main="Exemplar",
        ...
        body="Viti. Tabard +1",hands="Telchine Gloves",ring1="Prolix Ring",
	...
	sets.midcast['Enhancing Magic']['Refresh'] = set_combine(sets.midcast['Enhancing Magic'],{
		legs="Leth. Fuseau +1",back="Grapevine Cape",waist="Gishdubar Sash",feet="Inspirited Boots"})
 
    sets.midcast.Stoneskin = {waist="Siegel Sash"}

	-- Elemental Magic sets
	sets.midcast['Elemental Magic'] = {main="Bunzi's Rod",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
        head="Merlinic Hood",neck="Sanctity Necklace",lear="Malignance Earring",rear="Regal Earring",
        body="Merlinic Jubbah",hands="Jhakri Cuffs +2",ring1="Freke Ring",ring2="Metamor. Ring +1",
        back="Sucellos's Cape",waist="Sacro Cord",legs="Merlinic Shalwar",feet="Merlinic Crackows"}
    ...
    sets.midcast['Elemental Magic'].MAB = set_combine(sets.midcast['Elemental Magic'], 
	   {main="Bunzi's Rod",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
        ...
        back="Sucellos's Cape",waist="Sacro Cord",legs="Hagondes Pants +1",feet="Merlinic Crackows"})
  
    sets.midcast['Elemental Magic'].MB = set_combine(sets.midcast['Elemental Magic'], 
	   {main="Bunzi's Rod",sub="Ammurapi Shield",
		head="Atro. Chapeau +2",neck="Mizu. Kubikazari",
	...
	sets.midcast.Enfeebling.Skill = set_combine(sets.macc, {
        ...
        body="Lethargy Sayon +1",hands="Ayao's Gages",ring2="Globidonta Ring",
