...
function init_gear_sets()
	...
	-- Idle sets
	sets.idle = {head="Null Masque",neck="Elite Royal Collar",lear="Alabaster Earring",rear="Moonshade Earring",
		body="Sacro Breastplate",hands="Pel. Vambraces +3",ring1="Murky Ring",ring2="Renaye Ring +1",
		back=gear.critCape,waist="Null Belt",legs="Carmine Cuisses +1",feet="Nyame Sollerets"}
	...
	sets.engaged = {ammo="Coiste Bodhar",
		...
		body="Pelt. Plackart +3",hands="Pel. Vambraces +3",ring1="Niqmaddu Ring",ring2="Hetairoi Ring",
	...
	sets.Mode.Acc = set_combine(sets.engaged, { ammo="Amar Cluster",
        head="Peltast's Mezail +3",neck="Null Loop",lear="Zennaroi Earring",rear="Pel. Earring +1",
        body="Vishap Mail +3",hands="Pel. Vambraces +3",ring1="Regal Ring",ring2="Cacoethic Ring +1",
        back="Null Shawl",waist="Null Belt",legs="Vishap Brais +4",feet="Pelt. Schyn. +3"})
	sets.Mode.Att= set_combine(sets.engaged, {ammo="Knobkierrie",
        head="Peltast's Mezail +3",neck="Rep. Plat. Medal",lear="Bladeborn Earring",rear="Dudgeon Earring",
        body="Ptero. Mail +3",hands="Ptero. Fin. G. +4",ring1="Regal Ring",ring2="Overbearing Ring",
	...
	sets.Mode.Crit = set_combine(sets.engaged, {
		...
		body="Dagon Breast.",hands="Flam. Manopolas +2",ring1="Hetairoi Ring",
        back=gear.critCape,legs="Pelt. Cuissots +3",feet="Thereoid Greaves"})
	sets.Mode.DA = set_combine(sets.engaged, { ammo="Coiste Bodhar",
        ...
        body="Dagon Breast.",hands="Pel. Vambraces +3",ring1="Hetairoi Ring",ring2="Niqmaddu Ring",
        back="Null Shawl",waist="Sailfi Belt +1",legs="Sulev. Cuisses +2",feet="Flam. Gambieras +2"})
	...
	sets.Mode.sTP = set_combine(sets.engaged, { ammo="Coiste Bodhar",
        ...
        body="Pelt. Plackart +3",hands="Emicho Gauntlets",ring1="Rajas Ring",ring2="K'ayres Ring",
        back="Null Shawl",waist="Olseni Belt",legs="Ptero. Brais +3",feet="Valorous Greaves"})
	...
	sets.Mode.DT = set_combine(sets.engaged, { ammo="Crepuscular Pebble",
		...
		body="Nyame Mail",hands="Pel. Vambraces +3",ring1="Murky Ring",ring2="Patricius Ring",
		back=gear.critCape,waist="Plat. Mog. Belt",legs="Pelt. Cuissots +3",feet="Pelt. Schyn. +3"})
	sets.Mode.Meva = set_combine(sets.engaged, {
		...
		body="Nyame Mail",hands="Pel. Vambraces +3",ring1="Murky Ring",ring2="Moonbeam Ring",
		back="Null Shawl",waist="Null Belt",legs="Nyame Flanchard",feet="Pelt. Schyn. +3"})
		
	-- other Sets    
	sets.macc = {
		head="Peltast's Mezail +3",neck="Null Loop",lear="Crep. Earring",rear="Digni. Earring",
		body="Pelt. Plackart +3",hands="Pel. Vambraces +3",ring1="Sangoma Ring",
		back="Null Shawl",waist="Null Belt"}
	sets.PDL = {ammo="Crepuscular Pebble"}
	sets.empy = {head="Peltast's Mezail +3",
		body="Pelt. Plackart +3",hands="Pel. Vambraces +3",
		legs="Pelt. Cuissots +3",feet="Pelt. Schyn. +3"}		

	-- Sets with weapons defined.
	sets.engaged.Polearm = {}
	sets.engaged.Staff = {}
	sets.engaged.Polearm = set_combine(sets.engaged, {main="Gungnir",sub="Utu Grip"})
	...
	sets.engaged.Staff = set_combine(sets.engaged, {main="Malignance Pole",sub="Utu Grip"})
	...
	sets.engaged.Sword = set_combine(sets.engaged, {main="Naegling",sub="Joiner's Shield"})
	...
	sets.engaged.Sword.Eva = set_combine(sets.engaged.Sword, sets.Mode.Eva)
	...
	sets.precast.JA.Jumps = { ammo="Amar Cluster",
		head="Peltast's Mezail +3",neck="Dgn. Collar +2",lear="Sherida Earring",rear="Pel. Earring +1",
		body="Vishap Mail +3",hands="Vis. Fng. Gaunt. +3",ring1="Hetairoi Ring",ring2="K'ayres Ring",
		back=gear.critCape,waist="Sarissapho. Belt",legs="Pelt. Cuissots +3",feet="Vishap Greaves +3"}
	...
	sets.precast.JA['Spirit Jump'] = set_combine(sets.precast.JA.Jumps, {
		body="Ptero. Mail +3",legs="Pelt. Cuissots +3",feet="Pelt. Schyn. +3"})
	sets.precast.JA['Soul Jump'] = set_combine(sets.precast.JA.Jumps, {
		body="Ptero. Mail +3",legs="Pelt. Cuissots +3"})
	sets.precast.JA['Super Jump'] = { head="Twilight Helm", body="Twilight Mail"}
	sets.precast.JA.Angon = {ammo="Angon",lear="Dragoon's Earring",hands="Ptero. Fin. G. +4"}
	sets.precast.JA['Ancient Circle'] = {legs="Vishap Brais +4"}
	sets.precast.JA['Spirit Link'] = {head="Vishap Armet +3",rear="Pratik Earring",hands="Pel. Vambraces +3",feet="Ptero. Greaves +3"}
	sets.precast.JA['Call Wyvern'] = {neck="Dgn. Collar +2",rear="Pel. Earring +1",body="Ptero. Mail +3"}
	sets.precast.JA['Deep Breathing'] = {head="Ptero. Armet +3",hands="Ptero. Fin. G. +4"}
	...
	sets.Breath = {
		...
		back=gear.critCape,waist="Glassblower's Belt",legs="Vishap Brais +4",feet="Ptero. Greaves +3"}
	...
	sets.midcast.Breath.Food = set_combine(sets.Breath, {head="Ptero. Armet +3",body="Pelt. Plackart +3"})
			
	-- Waltz set (chr and vit)
	sets.precast.Waltz = { 
		head="Vishap Armet +3",neck="Phalaina Locket",rear="Roundel Earring", 
	...
	sets.precast.WS = set_combine(sets.Mode.STR, { ammo="Knobkierrie",
		head="Peltast's Mezail +3",neck="Fotia Gorget",lear="Ishvara Earring",rear="Thrud Earring",
		body="Phorcys Korazin",hands="Ptero. Fin. G. +4",ring1="Cornelia's Ring",ring2="Epaminondas's Ring",
		back=gear.wsdCape,waist="Fotia Belt",legs="Vishap Brais +4",feet="Sulev. Leggings +2"})
	...
	sets.precast.WS['Leg Sweep'] = set_combine(sets.precast.WS, {
		head="Peltast's Mezail +3",neck="Sanctity Necklace",lear="Digni. Earring",rear="Gwati Earring",
		body="Pelt. Plackart +3",hands="Pel. Vambraces +3",ring1="Metamor. Ring +1",ring2="Sangoma Ring",
		waist="Null Belt",legs="Pelt. Cuissots +3",feet="Pelt. Schyn. +3"})
	...
	sets.precast.WS['Geirskogul'] = set_combine(sets.precast.WS, {
		...
		body="Pelt. Plackart +3",ring1="Cornelia's Ring",ring2="Niqmaddu Ring"})
