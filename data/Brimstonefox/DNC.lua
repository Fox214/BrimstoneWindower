...
function init_gear_sets()
	...
	-- Normal melee group
    sets.engaged = { 
        head="Malignance Chapeau",neck="Null Loop",lear="Odr Earring",rear="Eabani Earring",
        body="Ashera Harness",hands="Herculean Gloves",ring1="Epona's Ring",ring2="Hetairoi Ring",
        back="Null Shawl",waist="Sarissapho. Belt",legs="Meg. Chausses +2",feet="Herculean Boots"}

	-- Basic Mode definitions
	sets.Mode = {}
	sets.Mode.Acc = set_combine(sets.engaged, {
		head="Malignance Chapeau",neck="Null Loop",lear="Zennaroi Earring",rear="Macu. Earring +1",
	...
	sets.Mode.STR = set_combine(sets.engaged, {
		head="Lilitu Headpiece",neck="Rep. Plat. Medal",
    ...
    sets.Mode.Eva = set_combine(sets.engaged, { 
        ...
        body="Nyame Mail",hands="Nyame Gauntlets",ring1="Beeline Ring",
    ...
    sets.Mode.DT = set_combine(sets.engaged, { ammo="Crepuscular Pebble",
        ...
        body="Meg. Cuirie +2",hands="Nyame Gauntlets",ring1="Murky Ring",ring2="Patricius Ring",
    ...
    sets.precast.WS['Aeolian Edge'] = set_combine(sets.precast.WS, {
        head="Nyame Helm",lear="Friomisi Earring",rear="Moonshade Earring",
    ...
    sets.precast.Waltz = {
        ...
        body="Dancer's Casaque",hands="Nyame Gauntlets",ring1="Metamor. Ring +1",
        back="Toetapper Mantle",legs="Nyame Flanchard",feet="Nyame Sollerets"}
