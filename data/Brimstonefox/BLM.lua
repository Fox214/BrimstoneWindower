...
function init_gear_sets()
    ...
    sets.engaged = { ammo="Amar Cluster",
        head="Jhakri Coronal +2",neck="Null Loop",lear="Brutal Earring",rear="Crep. Earring",
        body="Jhakri Robe +2",hands="Jhakri Cuffs +2",ring1="Patricius Ring",ring2="Apate Ring",
        back="Null Shawl",waist="Null Belt",legs="Miasmic Pants",feet="Jhakri Pigaches +2"}
	...
	sets.Mode.DA = set_combine(sets.engaged, {lear="Trux Earring",rear="Brutal Earring",ring2="Hetairoi Ring",
		back="Null Shawl",legs="Querkening Brais"})
	sets.Mode.SB = set_combine(sets.engaged, {neck="Combatant's Torque"})
	sets.Mode.sTP = set_combine(sets.engaged, {neck="Combatant's Torque",lear="Tripudio Earring",rear="Crep. Earring",
	...
	sets.midcast['Elemental Magic'] = {main="Bunzi's Rod",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
        head="Merlinic Hood",neck="Sanctity Necklace",lear="Malignance Earring",rear="Regal Earring1",
    ...
    sets.midcast['Elemental Magic'].INT = set_combine(sets.midcast['Elemental Magic'], 
	   {main="Marin Staff +1",sub="Enki Strap",ammo="Pemphredo Tathlum",
        head="Mall. Chapeau +2",neck="Sibyl Scarf",lear="Malignance Earring",rear="Regal Earring",
	...
	sets.midcast.Enfeebling.Skill = set_combine(sets.macc, {
        ...
        body="Shango Robe",hands="Ayao's Gages",ring2="Globidonta Ring",
    ...
    sets.midcast.ElementalEnfeeble = set_combine(sets.midcast['Enfeebling Magic'], {legs="Arch. Tonban +1"})

    sets.midcast['Dark Magic'] = set_combine(sets.macc, {
        neck="Erra Pendant",
        body="Shango Robe",hands="Arch. Gloves",ring1="Evanescence Ring",ring2="Kishar Ring",
        back="Bane Cape",legs="Spae. Tonban +1",feet="Wicce Sabots"})
