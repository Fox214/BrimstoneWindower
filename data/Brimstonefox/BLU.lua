...
function user_setup()
	...
	state.OffenseMode:options('Normal', 'Acc', 'Att', 'Crit', 'DA', 'SB', 'sTP', 'STR', 'Learning', 'Eva', 'DT', 'Meva')
...
function init_gear_sets()
	...
	sets.Learning = {ammo="Mavi Tathlum",
		...
		body="Assim. Jubbah +3",hands="Assim. Bazu. +1",ring1="Murky Ring",ring2="Renaye Ring +1",
	...
	sets.engaged = {ammo="Coiste Bodhar",
		head="Hashishin Kavuk +2",neck="Null Loop",lear="Odr Earring",rear="Eabani Earring",
		body="Hashishin Mintan +3",hands="Herculean Gloves",ring1="Epona's Ring",ring2="Hetairoi Ring",
		back="Null Shawl",waist="Sarissapho. Belt",legs="Hashishin Tayt +2",feet="Herculean Boots"}

	-- Basic Mode definitions
	sets.Mode = {}
	sets.Mode.Acc = set_combine(sets.engaged, {ammo="Mantoptera Eye",
		head="Hashishin Kavuk +2",neck="Null Loop",lear="Zennaroi Earring",rear="Hashi. Earring +1",
		body="Hashishin Mintan +3",hands="Aya. Manopolas +2",ring1="Mars's Ring",ring2="Cacoethic Ring +1",
		back="Null Shawl",waist="Null Belt",legs="Carmine Cuisses +1",feet="Aya. Gambieras +2"})
	sets.Mode.Att= set_combine(sets.engaged, {
		head="Hashishin Kavuk +2",neck="Rep. Plat. Medal",lear="Bladeborn Earring",rear="Dudgeon Earring",
		body="Hashishin Mintan +3",hands="Jhakri Cuffs +2",ring1="Overbearing Ring",ring2="Ilabrat Ring",
	...
	sets.Mode.DA = set_combine(sets.engaged, { ammo="Coiste Bodhar",
		...
		back="Null Shawl",waist="Sarissapho. Belt",legs="Zoar Subligar",feet="Herculean Boots"})
	sets.Mode.SB = set_combine(sets.engaged, {})
	sets.Mode.sTP = set_combine(sets.engaged, { ammo="Coiste Bodhar",
		head="Malignance Chapeau",neck="Combatant's Torque",lear="Crep. Earring",rear="Tripudio Earring",
		body="Herculean Vest",ring1="Rajas Ring",ring2="Ilabrat Ring",
		back="Null Shawl",waist="Yemaya Belt",legs="Jhakri Slops +2",feet="Battlecast Gaiters"})
	...
	sets.Mode.DT = set_combine(sets.engaged, { ammo="Crepuscular Pebble",
		...
		body="Hashishin Mintan +3",hands="Hashi. Bazu. +2",ring1="Murky Ring",ring2="Patricius Ring",
		back="Solemnity Cape",waist="Plat. Mog. Belt",legs="Hashishin Tayt +2",feet="Nyame Sollerets"})
	sets.Mode.Meva = set_combine(sets.engaged, {
		...
		body="Hashishin Mintan +3",hands="Hashi. Bazu. +2",ring1="Murky Ring",ring2="Moonbeam Ring",
		back="Null Shawl",waist="Null Belt",legs="Hashishin Tayt +2",feet="Nyame Sollerets"})
		
	-- other Sets    regal w/AF
	sets.macc = {ammo="Pemphredo Tathlum",
		head="Hashishin Kavuk +2",neck="Null Loop",lear="Crep. Earring",rear="Digni. Earring",
		body="Hashishin Mintan +3",hands="Jhakri Cuffs +2",ring1="Sangoma Ring",ring2="Metamor. Ring +1",
		back="Null Shawl",waist="Null Belt",legs="Jhakri Slops +2",feet="Jhakri Pigaches +2"}
	sets.PDL = {ammo="Crepuscular Pebble",head="Malignance Chapeau"}
	sets.empy = {head="Hashishin Kavuk +2",
		body="Hashishin Mintan +3",hands="Hashi. Bazu. +2",
	...
	sets.engaged.Shield.Sword = set_combine(sets.engaged, {main="Caliburnus",sub="Genmei Shield",lear="Digni. Earring",rear="Hashi. Earring +1"})
	sets.engaged.DW.Club = set_combine(sets.engaged, {main="Maxentius",sub="Bunzi's Rod"})
	sets.engaged.Shield.Club = set_combine(sets.engaged, {main="Maxentius",sub="Culminus"})
	...
	sets.engaged.DEX = {
		...
		body="Ayanmo Corazza +2",hands="Aya. Manopolas +2",ring1="Apate Ring",ring2="Ilabrat Ring",
		back="Rosmerta's Cape",waist="Wanion Belt",legs="Hashishin Tayt +2",feet="Aya. Gambieras +2"}
	sets.engaged.AGI = {
		head="Malignance Chapeau",lear="Infused Earring",rear="Suppanomimi",
		body="Sayadio's Kaftan",hands="Nyame Gauntlets",ring1="Apate Ring",ring2="Ilabrat Ring",
	...
	sets.precast.FC['Blue Magic'] = set_combine(sets.precast.FC, {body="Hashishin Mintan +3",hands="Hashi. Bazu. +2"})
	...
	sets.midcast['Blue Magic'].PhysicalInt = set_combine(sets.midcast['Blue Magic'].Physical,
		...
		body="Hashishin Mintan +3",hands="Jhakri Cuffs +2",
		back="Toro Cape",waist="Sacro Cord",legs="Jhakri Slops +2",feet="Jhakri Pigaches +2"})
	sets.midcast['Blue Magic'].PhysicalMnd = set_combine(sets.midcast['Blue Magic'].Physical,
		{lear="Lifestorm Earring",
		body="Hashishin Mintan +3",hands="Assim. Bazu. +1",
		back="Pahtli Cape",waist="Sacro Cord",legs="Feast Hose"})
