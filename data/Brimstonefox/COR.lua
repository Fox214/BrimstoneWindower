...
function init_gear_sets()
	...
	-- Normal melee group
	sets.engaged = {
        head="Malignance Chapeau",neck="Null Loop",lear="Odr Earring",rear="Suppanomimi",
	...
	sets.Mode.DA = set_combine(sets.engaged, {lear="Trux Earring",rear="Brutal Earring",
        ...
        back="Null Shawl",legs="Meg. Chausses +2"})
	...
	sets.Mode.STR = set_combine(sets.engaged, {
		head="Lanun Tricorne +3",neck="Rep. Plat. Medal",
    ...
    sets.Mode.DT = {
        ...
        back="Solemnity Cape",waist="Plat. Mog. Belt",legs="Chas. Culottes +2",feet="Nyame Sollerets"}
    sets.Mode.Meva = {
	...
	-- other Sets    
	sets.macc = {
		head="Malignance Chapeau",neck="Null Loop",lear="Crep. Earring",rear="Digni. Earring",
	...
	sets.empy = {head="Chasseur's Tricorne",
		body="Chasseur's Frac",hands="Chasseur's Gants +1",
		legs="Chas. Culottes +2",feet="Chasseur's Bottes"}
	...
	sets.precast.WS = set_combine(sets.Mode.STR, {
		...
		body="Laksa. Frac +3",hands="Chasseur's Gants +1",ring1="Cornelia's Ring",ring2="Epaminondas's Ring",
		back="Camulus's Mantle",waist="Fotia Belt",feet="Lanun Bottes +2"})    
    ...
    sets.precast.WS['Last Stand'] = set_combine(sets.precast.WS, {
		head="Lanun Tricorne +3",lear="Enervating Earring",ring2="Regal Ring",
		legs="Chas. Culottes +2"})

    sets.precast.WS['Wildfire'] = set_combine(sets.precast.WS, {ammo=gear.MAbullet,
        lear="Friomisi Earring",
        body="Lapidary Tunic",
        back="Toro Cape",legs="Chas. Culottes +2"})
    ...
    sets.precast.CorsairRoll = {head="Lanun Tricorne +3",hands="Chasseur's Gants +1",ring1="Barataria Ring",back="Camulus's Mantle"}
    ...
    sets.precast.CorsairShot = {head="Laksa. Tricorne"}
    ...
    sets.precast.RA = {ammo=gear.RAbullet,
        ...
        back="Navarch's Mantle",waist="Null Belt",legs="Laksa. Trews +1",feet="Meg. Jam. +2"}
    
    sets.midcast.CorsairShot = {ammo=gear.QDbullet,
        lear="Friomisi Earring",
        body="Lanun Frac",
        back="Gunslinger's Cape",waist="Null Belt",legs="Chas. Culottes +2",feet="Lanun Bottes +2"}

    sets.midcast.CorsairShot.Acc = set_combine(sets.midcast.CorsairShot, {ammo=gear.QDbullet,
        head="Laksa. Tricorne",lear="Lifestorm Earring",rear="Psystorm Earring",
        body="Lanun Frac",
        back="Gunslinger's Cape",legs="Chas. Culottes +2"})

	sets.midcast.QuickDraw = {ammo=gear.QDbullet,
        head="Laksa. Tricorne",lear="Lifestorm Earring",rear="Psystorm Earring",
        body="Lanun Frac",
        back="Gunslinger's Cape",legs="Chas. Culottes +2",feet="Laksa. Bottes"}
    ...
    sets.midcast.CorsairShot['Fire Shot'] = set_combine(sets.midcast.QuickDraw, {})
    sets.midcast.CorsairShot['Ice Shot'] = set_combine(sets.midcast.QuickDraw, {})
    sets.midcast.CorsairShot['Light Shot'] = set_combine(sets.midcast.QuickDraw, {})
    sets.midcast.CorsairShot['Thunder Shot'] = set_combine(sets.midcast.QuickDraw, {})
    sets.midcast.CorsairShot['Water Shot'] = set_combine(sets.midcast.QuickDraw, {})
    sets.midcast.CorsairShot['Wind Shot'] = set_combine(sets.midcast.QuickDraw, {})

    -- Ranged gear
	sets.midcast.RA = {
		head="Meghanada Visor +2",neck="Iskur Gorget",lear="Crep. Earring",rear="Enervating Earring",
		body="Meg. Cuirie +2",hands="Meg. Gloves +2",ring1="Paqichikaji Ring",ring2="Cacoethic Ring +1",
		back="Camulus's Mantle",waist="Null Belt",legs="Chas. Culottes +2",feet="Meg. Jam. +2"}
