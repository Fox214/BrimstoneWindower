...
function init_gear_sets()
	...
	sets.Mode.Acc = set_combine(sets.engaged, {
		...
		body="Pumm. Lorica +3",hands="Tatena. Gote +1",ring1="Cacoethic Ring +1",ring2="Regal Ring",
		back="Null Shawl",waist="Null Belt",legs="Sulev. Cuisses +2",feet="Valorous Greaves"})
	...
	sets.Mode.DA = set_combine(sets.engaged, {
		head="Flam. Zucchetto +2",neck="Asperity Necklace",lear="Schere Earring",rear="Boii Earring",
		body="Tatena. Harama. +1",hands="Sulev. Gauntlets +2",ring1="Niqmaddu Ring",ring2="Hetairoi Ring",
		back="Cichol's Mantle",waist="Ioskeha Belt",legs="Sulev. Cuisses +2",feet="Pumm. Calligae +2"})
	sets.Mode.SB = set_combine(sets.engaged, {lear="Schere Earring",
		body="Dagon Breast."})
	sets.Mode.sTP = set_combine(sets.engaged, {
		head="Sulevia's Mask +2",neck="Combatant's Torque",lear="Crep. Earring",rear="Tripudio Earring",
		body="Boii Lorica",hands="Tatena. Gote +1",ring1="Rajas Ring",ring2="K'ayres Ring",
		back="Null Shawl",waist="Olseni Belt",legs="Flamma Dirs +2",feet="Valorous Greaves"})
	sets.Mode.STR = set_combine(sets.engaged, {
		head="Flam. Zucchetto +2",neck="Rep. Plat. Medal",lear="Thrud Earring",
		body="Sulevia's Plate. +2",hands="Regal Cpt. Gloves",ring1="Niqmaddu Ring",ring2="Regal Ring",
	...
	-- other Sets 
	sets.macc = {
		head="Flam. Zucchetto +2",neck="Null Loop",lear="Crep. Earring",rear="Digni. Earring",
		body="Nyame Mail",hands="Nyame Gauntlets",ring1="Sangoma Ring",
		back="Null Shawl",waist="Null Belt",legs="Nyame Flanchard",feet="Flam. Gambieras +2"}
	sets.PDL = {}
	...
	sets.engaged.Grip.GreatAxe = set_combine(sets.engaged, {main="Instigator",sub="Utu Grip"})
	sets.engaged.Grip.GreatKatana = set_combine(sets.engaged, {main="Hardwood Katana",sub="Utu Grip"})
	...
	sets.engaged.Grip.Polearm = set_combine(sets.engaged, {main="Shining One", sub="Utu Grip"})
	sets.engaged.Grip.Scythe = set_combine(sets.engaged, {main="Pixquizpan", sub="Utu Grip"})
	...
	-- Ranged gear
    sets.midcast.RA = {
        head="Nyame Helm",neck="Null Loop",lear="Crep. Earring",rear="Enervating Earring",
