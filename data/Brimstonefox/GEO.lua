...
function user_setup()
    ...
    state.CastingMode:options('Normal', 'INT', 'MAB', 'Macc', 'MDmg', 'Proc')
...
function init_gear_sets()
    ...
    gear.idleCape = { name="Nantosuelta's Cape", augments={'HP+60','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','Pet: "Regen"+10','Pet: "Regen"+5',}}
    gear.nukeCape = { name="Nantosuelta's Cape", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','INT+10','"Mag.Atk.Bns."+10','Damage taken-5%',}}
    ...
    sets.idle = {range="Dunna",
        head="Null Masque",neck="Elite Royal Collar",lear="Moonshade Earring",rear="Azimuth Earring +1",
        body="Azimuth Coat +3",hands="Bagua Mitaines +3",ring1="Murky Ring",ring2="Renaye Ring +1",
        back=gear.nukeCape,waist="Null Belt",legs="Assid. Pants +1",feet="Geo. Sandals +3"}
   ...
   -- .Pet sets are for when Luopan is present.
    sets.idle.Pet = set_combine(sets.idle, {main="Idris",sub="Genmei Shield",range="Dunna",
        ...
        body="Azimuth Coat +3",hands="Geo. Mitaines +2",ring2="Renaye Ring +1",
        back=gear.idleCape,legs="Psycloth Lappas",feet="Bagua Sandals +3"})

    -- .Indi sets are for when an Indi-spell is active.
    sets.idle.Indi = set_combine(sets.idle, {back=gear.idleCape})
    ...
    sets.engaged = {range="Dunna",
        head="Azimuth Hood +2",neck="Null Loop",lear="Crep. Earring",rear="Ethereal Earring",
        body="Azimuth Coat +3",hands="Azimuth Gloves +2",ring1="Patricius Ring",ring2="Apate Ring",
        back="Null Shawl",waist="Null Belt",legs="Azimuth Tights +2",feet="Azimuth Gaiters +2"}
		
	-- Basic Mode definitions
	sets.Mode = {}
	sets.Mode.Acc = set_combine(sets.engaged, {
        head="Azimuth Hood +2",neck="Null Loop",lear="Zennaroi Earring",rear="Digni. Earring",
		body="Azimuth Coat +3",hands="Azimuth Gloves +2",ring1="Mars's Ring",ring2="Cacoethic Ring +1",
		back="Null Shawl",waist="Null Belt",legs="Azimuth Tights +2",feet="Azimuth Gaiters +2"})
	...
	sets.Mode.sTP = set_combine(sets.engaged, {lear="Crep. Earring",rear="Enervating Earring",
    ...
    sets.Mode.DT = set_combine(sets.engaged, {
        head="Azimuth Hood +2",neck="Null Loop",lear="Alabaster Earring",rear="Azimuth Earring +1",
        body="Nyame Mail",hands="Azimuth Gloves +2",ring1="Murky Ring",ring2="Patricius Ring",
        back=gear.nukeCape,waist="Plat. Mog. Belt",legs="Nyame Flanchard",feet="Azimuth Gaiters +2"})
    sets.Mode.Meva = set_combine(sets.engaged, {
		head="Azimuth Hood +2",lear="Etiolation Earring",rear="Eabani Earring",
        body="Nyame Mail",hands="Azimuth Gloves +2",ring1="Murky Ring",ring2="Vengeful Ring",
        back="Null Shawl",waist="Null Belt",legs="Nyame Flanchard",feet="Azimuth Gaiters +2"})
			
	-- other Sets    
	sets.macc = {main="Marin Staff +1",sub="Enki Strap",range="Dunna",
        head="Azimuth Hood +2",neck="Null Loop",lear="Malignance Earring",rear="Azimuth Earring +1",
        body="Azimuth Coat +3",hands="Azimuth Gloves +2",ring1="Sangoma Ring",ring2="Metamor. Ring +1",
        back="Null Shawl",waist="Null Belt",legs="Azimuth Tights +2",feet="Azimuth Gaiters +2"}
	sets.PDL = {}
    ...
    sets.precast.FC['Elemental Magic'] = set_combine(sets.precast.FC, {lear="Barkaro. Earring",hands="Bagua Mitaines +3",feet="Mallquis Clogs +2"})
    ...
    sets.midcast['Elemental Magic'] = { main="Idris",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
        head="Azimuth Hood +2",neck="Sanctity Necklace",lear="Malignance Earring",rear="Regal Earring",
        body="Azimuth Coat +3",hands="Azimuth Gloves +2",ring1="Freke Ring",ring2="Metamor. Ring +1",
        back=gear.nukeCape,waist="Sacro Cord",legs="Azimuth Tights +2",feet="Azimuth Gaiters +2"}
    ...
    sets.midcast['Elemental Magic'].INT = set_combine(sets.midcast['Elemental Magic'], 
	   {main="Marin Staff +1",sub="Enki Strap",ammo="Pemphredo Tathlum",
        head="Volte Beret",neck="Sibyl Scarf",lear="Malignance Earring",rear="Regal Earring",
        body="Jhakri Robe +2",hands="Mallquis Cuffs +2",ring1="Freke Ring",ring2="Metamor. Ring +1",
    ...
    sets.midcast['Elemental Magic'].MAB = set_combine(sets.midcast['Elemental Magic'], 
	   {main="Idris",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
        head="Bagua Galero +3",neck="Baetyl Pendant",lear="Malignance Earring",rear="Friomisi Earring",
        body="Merlinic Jubbah",hands="Bagua Mitaines +3",ring1="Freke Ring",ring2="Strendu Ring",
        back=gear.nukeCape,waist="Sacro Cord",legs="Azimuth Tights +2",feet="Merlinic Crackows"})
    ...
    sets.midcast['Elemental Magic'].MB = set_combine(sets.midcast['Elemental Magic'], {
		...
		body="Azimuth Coat +3",hands="Amalric Gages",ring1="Mujin Band",
    ...
    sets.midcast['Elemental Magic'].MDmg = set_combine(sets.midcast['Elemental Magic'], 
	   {main="Bunzi's Rod",sub="Culminus",ammo="Ghastly Tathlum +1",
        ...
        back=gear.nukeCape,waist="Sekhmet Corset",legs="Mallquis Trews +2",feet="Mallquis Clogs +2"})
	...
	sets.midcast.Enfeebling.Skill = set_combine(sets.macc, {
        ...
        body="Shango Robe",hands="Azimuth Gloves +2",ring2="Globidonta Ring",
        back="Lifestream Cape",waist="Rumination Sash",legs="Psycloth Lappas",feet="Bagua Sandals +3"})
	...
	sets.midcast['Enhancing Magic'] = {
        neck="Incanter's Torque",lear="Andoaa Earring",
    ...
    sets.midcast.Drain = set_combine(sets.midcast['Dark Magic'],{
		...
		head="Bagua Galero +3",neck="Erra Pendant",
		ring2="Excelsis Ring",waist="Fucho-no-obi",feet="Merlinic Crackows"})
    ...
    sets.midcast.Cure = set_combine(sets.midcast.StatusRemoval, {main="Bunzi's Rod",sub="Genmei Shield",
