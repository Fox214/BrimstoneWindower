...
function init_include()
	...
	options.WeaponModes = {'H2H', 'Polearm', 'Staff', 'Club', 'Dagger', 'GreatSword', 'GreatKatana', 'GreatAxe', 'Axe', 'Katana', 'Sword'}
	...
	-- If the user defined their own globals (user-globals.lua), use that; otherwise use Globals.
	...
	-- Global default binds (either from Globals or user-globals)
	binds_on_load()
